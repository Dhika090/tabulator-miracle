...
use App\Http\Requests\SHU\MandatoryCertification\Regional4MandatoryCertificationRequest;
use App\Models\SHU\MandatoryCertification\Regional4MandatoryCertification;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Regional4MandatoryCertificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHU.InputDataMonev.MandatoryCertification.Regional4MandatoryCertification', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Regional4MandatoryCertificationRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = Regional4MandatoryCertification::create($validated);
    ...
    {
        $TargetPLO = Regional4MandatoryCertification::select('*')
    ...
    public function update(Regional4MandatoryCertificationRequest $request, $id)
    {
        $progress = Regional4MandatoryCertification::findOrFail($id);
    ...
    {
        $target = Regional4MandatoryCertification::findOrFail($id);
        $target->delete();
