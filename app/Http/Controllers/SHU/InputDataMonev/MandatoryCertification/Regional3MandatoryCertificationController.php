...
use App\Http\Requests\SHU\MandatoryCertification\Regional3MandatoryCertificationRequest;
use App\Models\SHU\MandatoryCertification\Regional3MandatoryCertification;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Regional3MandatoryCertificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHU.InputDataMonev.MandatoryCertification.Regional3MandatoryCertification', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Regional3MandatoryCertificationRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = Regional3MandatoryCertification::create($validated);
    ...
    {
        $TargetPLO = Regional3MandatoryCertification::select('*')
    ...
    public function update(Regional3MandatoryCertificationRequest $request, $id)
    {
        $progress = Regional3MandatoryCertification::findOrFail($id);
    ...
    {
        $target = Regional3MandatoryCertification::findOrFail($id);
        $target->delete();
