...
namespace App\Http\Controllers\SHU\InputDataMonev\MandatoryCertification;

use App\Http\Controllers\Controller;
use App\Http\Requests\SHU\MandatoryCertification\Regional1MandatoryCertificationRequest;
use App\Models\SHG\WidarMandripa\MandatoryCertification;
use App\Models\SHU\MandatoryCertification\Regional1MandatoryCertification;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Regional1MandatoryCertificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHU.InputDataMonev.MandatoryCertification.Regional1MandatoryCertification', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Regional1MandatoryCertificationRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Regional1MandatoryCertification::create($validated);
    ...
    {
        $TargetPLO = Regional1MandatoryCertification::select('*')
    ...
    public function update(Regional1MandatoryCertificationRequest $request, $id)
    {
        $progress = Regional1MandatoryCertification::findOrFail($id);
    ...
    {
        $target = Regional1MandatoryCertification::findOrFail($id);
        $target->delete();
