...
use App\Http\Requests\SHU\TargetKinerja\TindakLanjut\HighlightStatusAiRequest;
use App\Models\SHU\TargetKinerja\TindakLanjut\HighlightStatusAi;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class HighlightStatusAiShuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHU.TargetKinerja.TindakLanjutMonev.HighlightStatusAi', compact('tabs'));
    }

    public function data()
    {
        $TargetPLO = HighlightStatusAi::select('*')
            ->select('*')
    ...
    public function store(HighlightStatusAiRequest $request)
    {
        $data = $request->validated();
        $data = HighlightStatusAi::create($data);
    ...
    public function update(HighlightStatusAiRequest $request, $id)
    {
        $progress = HighlightStatusAi::findOrFail($id);
    ...
    {
        $target = HighlightStatusAi::findOrFail($id);
        $target->delete();
