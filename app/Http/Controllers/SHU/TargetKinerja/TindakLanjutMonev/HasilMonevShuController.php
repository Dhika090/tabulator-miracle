...
use App\Http\Requests\SHU\TargetKinerja\TindakLanjut\MonevShuRequest;
use App\Models\SHU\TargetKinerja\TindakLanjut\MonevShuTindakLanjut;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class HasilMonevShuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHU.TargetKinerja.TindakLanjutMonev.HasilMonevShu', compact('tabs'));
    }

    public function data()
    {
        $TargetPLO = MonevShuTindakLanjut::select('*')
            ->select('*')
    ...
    public function store(MonevShuRequest $request)
    {
        $data = $request->validated();
        $data = MonevShuTindakLanjut::create($data);
    ...
    public function update(MonevShuRequest $request, $id)
    {
        $progress = MonevShuTindakLanjut::findOrFail($id);
    ...
    {
        $target = MonevShuTindakLanjut::findOrFail($id);
        $target->delete();
