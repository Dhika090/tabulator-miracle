...
use App\Http\Requests\SHIML\Pis\StatusPloPisRequest;
use App\Models\SHIML\Pis\StatusPloPis;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusPloPisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pis.StatusPloPis', compact('tabs'));
    }

    public function store(StatusPloPisRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloPis::create($validated);
    ...
    public function update(StatusPloPisRequest $request, $id)
    {
        $progress = StatusPloPis::findOrFail($id);
    ...
    {
        $target = StatusPloPis::findOrFail($id);
        $target->delete();
