...
use App\Http\Requests\SHIML\Pis\AssetBreakdownPisRequest;
use App\Models\SHIML\Pis\AssetBreakdownPis;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownPisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pis.AssetBreakdownPis', compact('tabs'));
    }

    public function store(AssetBreakdownPisRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownPis::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownPis::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakdownPisRequest $request, $id)
    {
        $progress = AssetBreakdownPis::findOrFail($id);
    ...
    {
        $target = AssetBreakdownPis::findOrFail($id);
        $target->delete();
