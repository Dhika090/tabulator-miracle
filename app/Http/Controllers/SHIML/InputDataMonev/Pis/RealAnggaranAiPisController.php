...
use App\Http\Requests\SHIML\Pis\RealAnggaranAiPisRequest;
use App\Models\SHIML\Pis\RealAnggaranAiPis;
...
class RealAnggaranAiPisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pis.RealAnggaranAiPis', compact('tabs'));
    }

    public function store(RealAnggaranAiPisRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiPis::create($validated);
    ...
    public function update(RealAnggaranAiPisRequest $request, $id)
    {
        $progress = RealAnggaranAiPis::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiPis::findOrFail($id);
        $target->delete();
