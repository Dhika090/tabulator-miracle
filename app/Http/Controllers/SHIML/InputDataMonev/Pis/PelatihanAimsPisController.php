...
use App\Http\Requests\SHIML\Pis\PelatihanAimsPisRequest;
use App\Models\SHIML\Pis\PelatihanAimsPis;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsPisController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pis.PelatihanAimsPis', compact('tabs'));
    }

    public function store(PelatihanAimsPisRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsPis::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsPis::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsPisRequest $request, $id)
    {
        $progress = PelatihanAimsPis::findOrFail($id);
    ...
    {
        $target = PelatihanAimsPis::findOrFail($id);
        $target->delete();
