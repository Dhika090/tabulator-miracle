...
use App\Http\Requests\SHIML\Pet\RealProgFisikAiPetRequest;
use App\Models\SHIML\Pet\RealProgFisikAiPet;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiPetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pet.RealProgFisikAiPet', compact('tabs'));
    }

    public function store(RealProgFisikAiPetRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiPet::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiPet::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiPetRequest $request, $id)
    {
        $progress = RealProgFisikAiPet::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiPet::findOrFail($id);
        $target->delete();
