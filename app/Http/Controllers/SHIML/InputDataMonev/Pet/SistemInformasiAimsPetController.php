...
use App\Http\Requests\SHIML\Pet\SistemInformasiAimsPetRequest;
use App\Models\SHIML\Pet\SistemInformasiAimsPet;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsPetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pet.SistemInformasiAimsPet', compact('tabs'));
    }

    public function store(SistemInformasiAimsPetRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsPet::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsPet::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsPetRequest $request, $id)
    {
        $progress = SistemInformasiAimsPet::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsPet::findOrFail($id);
        $target->delete();
