...
use App\Http\Requests\SHIML\Pet\StatusAssetAiPetRequest;
use App\Models\SHIML\Pet\StatusAssetAiPet;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusAsseAiPetController extends Controller
{

    public function index(Request $request)
    {
        if ($request->wantsJson()) {
            $TargetPLO = StatusAssetAiPet::all();
        ...
        return view('SHIML.InputDataMonev.Pet.StatusAssetAiPet', compact('tabs', 'companies'));
    }

    public function store(StatusAssetAiPetRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusAssetAiPet::create($validated);
    ...
    public function update(StatusAssetAiPetRequest $request, $id)
    {
        $progress = StatusAssetAiPet::findOrFail($id);
    ...
    {
        $target = StatusAssetAiPet::findOrFail($id);
        $target->delete();
