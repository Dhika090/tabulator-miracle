...
use App\Http\Requests\SHIML\Pet\AvailabilityPetRequest;
use App\Models\SHIML\Pet\AvailabilityPet;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityPetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pet.AvailabilityPet', compact('tabs'));
    }

    public function store(AvailabilityPetRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityPet::create($validated);
    ...
    {
        $TargetPLO = AvailabilityPet::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityPetRequest $request, $id)
    {
        $progress = AvailabilityPet::findOrFail($id);
    ...
    {
        $target = AvailabilityPet::findOrFail($id);
        $target->delete();
