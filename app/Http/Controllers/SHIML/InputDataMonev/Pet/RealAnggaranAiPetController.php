...
use App\Http\Requests\SHIML\Pet\RealAnggaranAiPetRequest;
use App\Models\SHIML\Pet\RealAnggaranAiPet;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiPetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Pet.RealAnggaranAiPet', compact('tabs'));
    }

    public function store(RealAnggaranAiPetRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiPet::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiPet::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranAiPetRequest $request, $id)
    {
        $progress = RealAnggaranAiPet::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiPet::findOrFail($id);
        $target->delete();
