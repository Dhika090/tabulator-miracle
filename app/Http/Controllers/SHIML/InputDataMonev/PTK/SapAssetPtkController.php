...
use App\Http\Requests\SHIML\PTK\SapAssetPtkRequest;
use App\Models\SHIML\PTK\SapAssetPtk;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SapAssetPtkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Ptk.SapAssetPtk', compact('tabs'));
    }

    public function store(SapAssetPtkRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SapAssetPtk::create($validated);
    ...
    public function update(SapAssetPtkRequest $request, $id)
    {
        $progress = SapAssetPtk::findOrFail($id);
    ...
    {
        $target = SapAssetPtk::findOrFail($id);
        $target->delete();
