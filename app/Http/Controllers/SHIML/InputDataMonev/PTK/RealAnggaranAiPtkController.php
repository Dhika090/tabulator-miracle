...
use App\Http\Requests\SHIML\PTK\RealAnggaranAiPtkRequest;
use App\Models\SHIML\PTK\RealAnggaraAiPtk;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiPtkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Ptk.RealAnggaranAiPtk', compact('tabs'));
    }

    public function store(RealAnggaranAiPtkRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaraAiPtk::create($validated);
    ...
    {
        $TargetPLO = RealAnggaraAiPtk::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranAiPtkRequest $request, $id)
    {
        $progress = RealAnggaraAiPtk::findOrFail($id);
    ...
    {
        $target = RealAnggaraAiPtk::findOrFail($id);
        $target->delete();
