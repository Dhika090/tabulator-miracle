...
use App\Http\Requests\SHIML\PTK\AvailabilityPtkRequest;
use App\Models\SHIML\PTK\AvailabilityPtk;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityPtkController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Ptk.AvailabilityPtk', compact('tabs'));
    }

    public function store(AvailabilityPtkRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityPtk::create($validated);
    ...
    {
        $TargetPLO = AvailabilityPtk::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityPtkRequest $request, $id)
    {
        $progress = AvailabilityPtk::findOrFail($id);
    ...
    {
        $target = AvailabilityPtk::findOrFail($id);
        $target->delete();
