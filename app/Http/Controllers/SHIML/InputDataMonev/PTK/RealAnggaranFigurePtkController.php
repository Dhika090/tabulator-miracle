...
use App\Http\Requests\SHIML\PTK\RealAnggaranFigurePtkRequest;
use App\Models\SHIML\PTK\RealAnggaraFigurePtk;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigurePtkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Ptk.RealAnggaranFigurePtk', compact('tabs'));
    }

    public function store(RealAnggaranFigurePtkRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaraFigurePtk::create($validated);
    ...
    {
        $TargetPLO = RealAnggaraFigurePtk::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranFigurePtkRequest $request, $id)
    {
        $progress = RealAnggaraFigurePtk::findOrFail($id);
    ...
    {
        $target = RealAnggaraFigurePtk::findOrFail($id);
        $target->delete();
