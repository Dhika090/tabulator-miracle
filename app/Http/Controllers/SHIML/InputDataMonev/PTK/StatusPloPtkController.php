...
use App\Http\Requests\SHIML\PTK\StatusPloPtkRequest;
use App\Models\SHIML\PTK\StatusPloPtk;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusPloPtkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Ptk.StatusPloPtk', compact('tabs'));
    }

    public function store(StatusPloPtkRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloPtk::create($validated);
    ...
    public function update(StatusPloPtkRequest $request, $id)
    {
        $progress = StatusPloPtk::findOrFail($id);
    ...
    {
        $target = StatusPloPtk::findOrFail($id);
        $target->delete();
