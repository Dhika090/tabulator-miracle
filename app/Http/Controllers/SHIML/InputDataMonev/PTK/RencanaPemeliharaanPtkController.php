...
use App\Http\Requests\SHIML\PTK\RencanaPemeliharaanPtkRequest;
use App\Models\SHIML\PTK\RencanaPemeliharaanPtk;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanPtkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHIML.InputDataMonev.Ptk.RencanaPemeliharaanPtk', compact('tabs'));
    }

    public function store(RencanaPemeliharaanPtkRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanPtk::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanPtk::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RencanaPemeliharaanPtkRequest $request, $id)
    {
        $progress = RencanaPemeliharaanPtk::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanPtk::findOrFail($id);
        $target->delete();
