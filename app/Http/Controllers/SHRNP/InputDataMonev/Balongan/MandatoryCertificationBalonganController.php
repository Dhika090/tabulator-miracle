...
use App\Http\Requests\SHRNP\Balongan\MandatoryCertificationBalonganRequest;
use App\Models\SHRNP\Balongan\MandatoryCertificationBalongan;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class MandatoryCertificationBalonganController extends Controller
{
    ...
    public function store(MandatoryCertificationBalonganRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = MandatoryCertificationBalongan::create($validated);
    ...
    {
        $TargetPLO = MandatoryCertificationBalongan::select('*')
    ...
    public function update(MandatoryCertificationBalonganRequest $request, $id)
    {
        $progress = MandatoryCertificationBalongan::findOrFail($id);
    ...
    {
        $target = MandatoryCertificationBalongan::findOrFail($id);
        $target->delete();
