...
use App\Http\Requests\SHRNP\Balikpapan\MandatoryCertificationBalikpapanRequest;
use App\Models\SHRNP\Balikpapan\MandatoryCertificationBalikpapan;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class MandatoryCertificationBalikpapanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Balikpapan.MandatoryCertificationBalikpapan', [
            'tabs' => $tabs,
    ...
    public function store(MandatoryCertificationBalikpapanRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = MandatoryCertificationBalikpapan::create($validated);
    ...
    {
        $TargetPLO = MandatoryCertificationBalikpapan::select('*')
    ...
    public function update(MandatoryCertificationBalikpapanRequest $request, $id)
    {
        $progress = MandatoryCertificationBalikpapan::findOrFail($id);
    ...
    {
        $target = MandatoryCertificationBalikpapan::findOrFail($id);
        $target->delete();
