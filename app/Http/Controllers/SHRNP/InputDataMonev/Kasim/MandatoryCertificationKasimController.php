...
use App\Http\Requests\SHRNP\Kasim\MandatoryCertificationKasimRequest;
use App\Models\SHRNP\Kasim\MandatoryCertificationKasim;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class MandatoryCertificationKasimController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Kasim.MandatoryCertificationKasim', [
            'tabs' => $tabs,
    ...
    public function store(MandatoryCertificationKasimRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = MandatoryCertificationKasim::create($validated);
    ...
    {
        $TargetPLO = MandatoryCertificationKasim::select('*')
    ...
    public function update(MandatoryCertificationKasimRequest $request, $id)
    {
        $progress = MandatoryCertificationKasim::findOrFail($id);
    ...
    {
        $target = MandatoryCertificationKasim::findOrFail($id);
        $target->delete();
