...
use App\Http\Requests\SHRNP\RuDumai\RealAnggaranAiRuDumaiRequest;
use App\Models\SHRNP\RuDumai\RealAnggaranAiRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.RealAnggaranAiRuDumai', compact('tabs'));
    }

    public function store(RealAnggaranAiRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiRuDumai::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    {
        $progress = RealAnggaranAiRuDumai::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiRuDumai::findOrFail($id);
        $target->delete();
