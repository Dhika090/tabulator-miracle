...
use App\Models\SHRNP\RuDumai\KondisiVacantAimsRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.KondisiVacantAimsRuDumai', compact('tabs'));
    }


    public function store(KondisiVacantAimstRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsRuDumai::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    {
        $progress = KondisiVacantAimsRuDumai::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsRuDumai::findOrFail($id);
        $target->delete();
