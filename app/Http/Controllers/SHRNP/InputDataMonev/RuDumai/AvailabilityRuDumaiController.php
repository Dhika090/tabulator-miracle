...
use App\Http\Requests\SHRNP\RuDumai\AvailabilityRuDumaiRequest;
use App\Models\SHRNP\RuDumai\AvailabilityRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.AvailabilityRuDumai', compact('tabs'));
    }

    public function store(AvailabilityRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityRuDumai::create($validated);
    ...
    {
        $TargetPLO = AvailabilityRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityRuDumaiRequest $request, $id)
    {
        $progress = AvailabilityRuDumai::findOrFail($id);
    ...
    {
        $target = AvailabilityRuDumai::findOrFail($id);
        $target->delete();
