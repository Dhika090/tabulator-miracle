...
use App\Http\Requests\SHRNP\RuDumai\SistemInformasiAimstRuDumaiRequest;
use App\Models\SHRNP\RuDumai\SistemInformasiAimsRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.SistemInformasiAimsRuDumai', compact('tabs'));
    }

    public function store(SistemInformasiAimstRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsRuDumai::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimstRuDumaiRequest $request, $id)
    {
        $progress = SistemInformasiAimsRuDumai::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsRuDumai::findOrFail($id);
        $target->delete();
