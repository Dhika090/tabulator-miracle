...
use App\Http\Requests\SHRNP\RuDumai\StatusPloRuDumaiRequest;
use App\Models\SHRNP\RuDumai\StatusPloRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusPloRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.StatusPloRuDumai', compact('tabs'));
    }

    public function store(StatusPloRuDumai $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloRuDumai::create($validated);
    ...
    {
        $TargetPLO = StatusPloRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(StatusPloRuDumaiRequest $request, $id)
    {
        $progress = StatusPloRuDumai::findOrFail($id);
    ...
    {
        $target = StatusPloRuDumai::findOrFail($id);
        $target->delete();
