...
use App\Models\SHRNP\RuDumai\PelatihanAimsRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.PelatihanAimsRuDumai', compact('tabs'));
    }

    public function store(PelatihanAimstRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsRuDumai::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    {
        $progress = PelatihanAimsRuDumai::findOrFail($id);
    ...
    {
        $target = PelatihanAimsRuDumai::findOrFail($id);
        $target->delete();
