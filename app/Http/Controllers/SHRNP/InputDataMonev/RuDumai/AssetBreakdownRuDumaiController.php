...
use App\Http\Requests\SHRNP\RuDumai\AssetBreakdownRuDumaiRequest;
use App\Models\SHRNP\RuDumai\AssetBreakdownRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.AssetBreakdownRuDumai', compact('tabs'));
    }

    public function store(AssetBreakdownRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownRuDumai::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownRuDumai::select('*')
    ...
    public function update(AssetBreakdownRuDumaiRequest $request, $id)
    {
        $progress = AssetBreakdownRuDumai::findOrFail($id);
    ...
    {
        $target = AssetBreakdownRuDumai::findOrFail($id);
        $target->delete();
