...
use App\Http\Requests\SHRNP\RuDumai\PelatihanAimstRuDumaiRequest;
use App\Models\SHRNP\RuDumai\RencanaPemeliharaanRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.RencanaPemeliharaanRuDumai', compact('tabs'));
    }

    public function store(PelatihanAimstRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanRuDumai::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimstRuDumaiRequest $request, $id)
    {
        $progress = RencanaPemeliharaanRuDumai::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanRuDumai::findOrFail($id);
        $target->delete();
