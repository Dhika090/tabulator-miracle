...
use App\Http\Requests\SHRNP\RuDumai\StatusAssetAiRuDumaiRequest;
use App\Models\SHRNP\RuDumai\StatusAssetAiRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusAssetAiRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            $TargetPLO = StatusAssetAiRuDumai::all();
        ...
        return view('SHRNP.InputDataMonev.RuDumai.StatusAssetAiRuDumai', compact('tabs','companies'));
    }

    public function store(StatusAssetAiRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusAssetAiRuDumai::create($validated);
    ...
    {
        $TargetPLO = StatusAssetAiRuDumai::select('*')
    ...
    public function update(StatusAssetAiRuDumaiRequest $request, $id)
    {
        $progress = StatusAssetAiRuDumai::findOrFail($id);
    ...
    {
        $target = StatusAssetAiRuDumai::findOrFail($id);
        $target->delete();
