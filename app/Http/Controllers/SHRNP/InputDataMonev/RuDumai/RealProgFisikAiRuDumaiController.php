...
use App\Http\Requests\SHRNP\RuDumai\RealProgFisikAiRuDumaiRequest;
use App\Models\SHRNP\RuDumai\RealProgFisikAiRuDumai;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiRuDumaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.RuDumai.RealProgFisikAiRuDumai', compact('tabs'));
    }

    public function store(RealProgFisikAiRuDumaiRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiRuDumai::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiRuDumai::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiRuDumaiRequest $request, $id)
    {
        $progress = RealProgFisikAiRuDumai::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiRuDumai::findOrFail($id);
        $target->delete();
