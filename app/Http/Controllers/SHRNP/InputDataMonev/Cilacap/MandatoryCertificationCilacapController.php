...
use App\Http\Requests\SHRNP\Cilacap\MandatoryCertificationCilacapRequest;
use App\Models\SHG\WidarMandripa\MandatoryCertification;
use App\Models\SHRNP\Cilacap\MandatoryCertificationCilacap;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class MandatoryCertificationCilacapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Cilacap.MandatoryCertificationCilacap', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(MandatoryCertificationCilacapRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = MandatoryCertificationCilacap::create($validated);
    ...
    {
        $TargetPLO = MandatoryCertificationCilacap::select('*')
    ...
    public function update(MandatoryCertificationCilacapRequest $request, $id)
    {
        $progress = MandatoryCertificationCilacap::findOrFail($id);
    ...
    {
        $target = MandatoryCertificationCilacap::findOrFail($id);
        $target->delete();
