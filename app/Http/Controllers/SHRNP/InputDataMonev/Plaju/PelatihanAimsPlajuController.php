...
use App\Http\Requests\SHRNP\Plaju\PelatihanAimsPlajuRequest;
use App\Models\SHRNP\Plaju\PelatihanAimsPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.PelatihanAimsPlaju', compact('tabs'));
    }

    public function store(PelatihanAimsPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsPlaju::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsPlajuRequest $request, $id)
    {
        $progress = PelatihanAimsPlaju::findOrFail($id);
    ...
    {
        $target = PelatihanAimsPlaju::findOrFail($id);
        $target->delete();
