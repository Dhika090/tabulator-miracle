...
use App\Http\Requests\SHRNP\Plaju\RealAnggaranAiPlajuRequest;
use App\Models\SHRNP\Plaju\RealAnggaranAiPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.RealAnggaranAiPlaju', compact('tabs'));
    }

    public function store(RealAnggaranAiPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiPlaju::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranAiPlajuRequest $request, $id)
    {
        $progress = RealAnggaranAiPlaju::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiPlaju::findOrFail($id);
        $target->delete();
