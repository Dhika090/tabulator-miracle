...
use App\Http\Requests\SHRNP\Plaju\KondisiVacantAimsPlajuRequest;
use App\Models\SHRNP\Plaju\KondisiVacantAimsPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.KondisiVacantAimsPlaju', compact('tabs'));
    }

    public function store(KondisiVacantAimsPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsPlaju::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(KondisiVacantAimsPlajuRequest $request, $id)
    {
        $progress = KondisiVacantAimsPlaju::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsPlaju::findOrFail($id);
        $target->delete();
