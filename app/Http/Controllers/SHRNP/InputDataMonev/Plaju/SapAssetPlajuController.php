...
use App\Http\Requests\SHRNP\Plaju\SapAssetPlajuRequest;
use App\Models\SHRNP\Plaju\SapAssetAiPlaju;
use App\Models\SHRNP\Plaju\SapAssetPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SapAssetPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.SapAssetPlaju', compact('tabs'));
    }

    public function store(SapAssetPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SapAssetPlaju::create($validated);
    ...
    {
        $TargetPLO = SapAssetPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SapAssetPlajuRequest $request, $id)
    {
        $progress = SapAssetPlaju::findOrFail($id);
    ...
    {
        $target = SapAssetPlaju::findOrFail($id);
        $target->delete();
