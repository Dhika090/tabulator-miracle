...
use App\Http\Requests\SHRNP\Plaju\RealAnggaranFigurePlajuRequest;
use App\Models\SHRNP\Plaju\RealAnggaranFigurePlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigurePlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.RealAnggaranFigureRuPlaju', compact('tabs'));
    }

    public function store(RealAnggaranFigurePlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranFigurePlaju::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranFigurePlaju::select('*')
    ...
    public function update(RealAnggaranFigurePlajuRequest $request, $id)
    {
        $progress = RealAnggaranFigurePlaju::findOrFail($id);
    ...
    {
        $target = RealAnggaranFigurePlaju::findOrFail($id);
        $target->delete();
