...
use App\Http\Requests\SHRNP\Plaju\AssetBreakdownPlajuRequest;
use App\Models\SHRNP\Plaju\AssetBreakdownPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.AssetBreakdownPlaju', compact('tabs'));
    }

    public function store(AssetBreakdownPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownPlaju::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakdownPlajuRequest $request, $id)
    {
        $progress = AssetBreakdownPlaju::findOrFail($id);
    ...
    {
        $target = AssetBreakdownPlaju::findOrFail($id);
        $target->delete();
