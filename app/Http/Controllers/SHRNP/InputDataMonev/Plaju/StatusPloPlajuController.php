...
use App\Http\Requests\SHRNP\Plaju\StatusPloPlajuRequest;
use App\Models\SHRNP\Plaju\StatusPloPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusPloPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.StatusPloPlaju', compact('tabs'));
    }

    public function store(StatusPloPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloPlaju::create($validated);
    ...
    {
        $TargetPLO = StatusPloPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(StatusPloPlajuRequest $request, $id)
    {
        $progress = StatusPloPlaju::findOrFail($id);
    ...
    {
        $target = StatusPloPlaju::findOrFail($id);
        $target->delete();
