...
use App\Http\Requests\SHRNP\Plaju\RealProgfisikAiPlajuRequest;
use App\Models\SHRNP\Plaju\RealProgFisikAiPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.RealProgFisikAiPlaju', compact('tabs'));
    }

    public function store(RealProgFisikAiPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiPlaju::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgfisikAiPlajuRequest $request, $id)
    {
        $progress = RealProgFisikAiPlaju::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiPlaju::findOrFail($id);
        $target->delete();
