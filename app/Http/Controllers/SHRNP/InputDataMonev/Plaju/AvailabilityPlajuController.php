...
use App\Http\Requests\SHRNP\Plaju\AvailabilityPlajuRequest;
use App\Models\SHRNP\Plaju\AvailabilityPlaju;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityPlajuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHRNP.InputDataMonev.Plaju.AvailabilityPlaju', compact('tabs'));
    }

    public function store(AvailabilityPlajuRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityPlaju::create($validated);
    ...
    {
        $TargetPLO = AvailabilityPlaju::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityPlajuRequest $request, $id)
    {
        $progress = AvailabilityPlaju::findOrFail($id);
    ...
    {
        $target = AvailabilityPlaju::findOrFail($id);
        $target->delete();
