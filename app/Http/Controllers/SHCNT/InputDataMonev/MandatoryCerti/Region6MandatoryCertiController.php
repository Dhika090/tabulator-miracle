...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion6MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion6MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region6MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion6MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion6MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion6MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion6MandatoryCerti::select('*')
    ...
    public function update(Reqion6MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion6MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion6MandatoryCerti::findOrFail($id);
        $target->delete();
