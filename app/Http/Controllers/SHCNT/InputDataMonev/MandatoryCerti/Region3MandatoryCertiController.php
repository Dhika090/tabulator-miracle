...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion3MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion3MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region3MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion3MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion3MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion3MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion3MandatoryCerti::select('*')
    ...
    public function update(Reqion3MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion3MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion3MandatoryCerti::findOrFail($id);
        $target->delete();
