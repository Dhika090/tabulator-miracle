...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion4MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion4MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region4MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion4MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion4MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion4MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion4MandatoryCerti::select('*')
    ...
    public function update(Reqion4MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion4MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion4MandatoryCerti::findOrFail($id);
        $target->delete();
