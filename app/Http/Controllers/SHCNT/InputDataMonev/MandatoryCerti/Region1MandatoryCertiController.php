...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion1MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion1MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region1MandatoryCertiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion1MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion1MandatoryCertiRequest $request)
    {
    ...
    {
        $TargetPLO = Reqion1MandatoryCerti::select('*')
    ...
    public function update(Reqion1MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion1MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion1MandatoryCerti::findOrFail($id);
        $target->delete();
