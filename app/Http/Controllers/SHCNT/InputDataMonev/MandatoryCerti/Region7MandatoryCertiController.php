...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion7MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion7MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region7MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion7MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion7MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion7MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion7MandatoryCerti::select('*')
    ...
    public function update(Reqion7MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion7MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion7MandatoryCerti::findOrFail($id);
        $target->delete();
