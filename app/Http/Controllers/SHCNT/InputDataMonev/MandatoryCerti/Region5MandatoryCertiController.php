...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion5MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion5MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region5MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion5MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion5MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion5MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion5MandatoryCerti::select('*')
    ...
    public function update(Reqion5MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion5MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion5MandatoryCerti::findOrFail($id);
        $target->delete();
