...
namespace App\Http\Controllers\SHCNT\InputDataMonev\MandatoryCerti;

use App\Http\Controllers\Controller;
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion2MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion1MandatoryCerti;
use App\Models\SHCNT\MandatoryCertification\Reqion2MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region2MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion2MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion2MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion1MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion2MandatoryCerti::select('*')
    ...
    public function update(Reqion2MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion2MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion2MandatoryCerti::findOrFail($id);
        $target->delete();
