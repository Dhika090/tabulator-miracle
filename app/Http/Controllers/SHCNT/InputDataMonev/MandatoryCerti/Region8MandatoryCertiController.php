...
use App\Http\Requests\SHCNT\MandatoryCertification\Reqion8MandatoryCertiRequest;
use App\Models\SHCNT\MandatoryCertification\Reqion8MandatoryCerti;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class Region8MandatoryCertiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHCNT.InputDataMonev.MandatoryCertification.Reqion8MandatoryCerti', [
            'tabs' => $tabs,
            'sertifikasiOptions' => $sertifikasiOptions
        ]);
    }

    public function store(Reqion8MandatoryCertiRequest $request)
    {


        $validated = $request->validated();
        $TargetPLO = Reqion8MandatoryCerti::create($validated);
    ...
    {
        $TargetPLO = Reqion8MandatoryCerti::select('*')
    ...
    public function update(Reqion8MandatoryCertiRequest $request, $id)
    {
        $progress = Reqion8MandatoryCerti::findOrFail($id);
    ...
    {
        $target = Reqion8MandatoryCerti::findOrFail($id);
        $target->delete();
