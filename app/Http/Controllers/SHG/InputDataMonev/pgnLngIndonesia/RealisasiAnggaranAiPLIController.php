...
class RealisasiAnggaranAiPLIController extends Controller
{
    ...
    public function store(RealisasiAnggaranAiPlIRequest $request)
    {
        ...
        $data = RealisasiAnggaranAiPli::create($data);
    ...
    public function update(RealisasiAnggaranAiPlIRequest $request, $id)
    {
        $progress = RealisasiAnggaranAiPli::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiPli::findOrFail($id);
        $target->delete();
