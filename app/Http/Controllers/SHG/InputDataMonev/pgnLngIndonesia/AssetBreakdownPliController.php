...
class AssetBreakdownPliController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PgnLngIndonesia.AssetBreakdownPLI', compact('tabs'));
    }


    public function data()
    {
        return response()->json(AssetBreakdownPLI::all());
    }

    public function store(AssetBreakdownPliRequest $request)
    {
        $data = $request->validated();
        $data = AssetBreakdownPLI::create($data);
    ...
    public function update(AssetBreakdownPliRequest $request, $id)
    {
        $progress = AssetBreakdownPLI::findOrFail($id);
    ...
    {
        $target = AssetBreakdownPLI::findOrFail($id);
        $target->delete();
