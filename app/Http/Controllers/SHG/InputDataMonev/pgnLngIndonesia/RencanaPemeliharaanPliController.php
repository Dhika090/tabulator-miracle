...
class RencanaPemeliharaanPliController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.pgnLngIndonesia.RencanaPemeliharaanPli2025', compact('tabs'));
    }
    ...
    public function store(RencanaPemeliharaanPliRequest $request)
    {
        ...
        $data = RencanaPemeliharaanPLI::create($data);
    ...
    public function update(RencanaPemeliharaanPliRequest $request, $id)
    {
        $progress = RencanaPemeliharaanPLI::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanPLI::findOrFail($id);
        $target->delete();
