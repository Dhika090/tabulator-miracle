...
use App\Http\Requests\SHG\PgnLngIndonesia\KondisiVacantAimsPliRequest;
use App\Models\SHG\PgnLngIndonesia\KondisiVacantAimsPLI;
...
class KondisiVacantAimsPliController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PgnLngIndonesia.KondisiVacantFungsiAimsPLI', compact('tabs'));
    }

    public function data()
    {
        return response()->json(KondisiVacantAimsPLI::all());
    }

    public function store(KondisiVacantAimsPliRequest $request)
    {
        $data = $request->validated();
        $data = KondisiVacantAimsPLI::create($data);
    ...
    public function update(KondisiVacantAimsPliRequest $request, $id)
    {
        $progress = KondisiVacantAimsPLI::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsPLI::findOrFail($id);
        $target->delete();
