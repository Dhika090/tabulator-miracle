...
use App\Http\Requests\SHG\PgnLngIndonesia\StatusPloPliRequest;
use App\Models\SHG\PgnLngIndonesia\StatusPloPli;
use Illuminate\Http\Request;

class StatusPloPliController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PgnLngIndonesia.StatusPloPLI', compact('tabs'));
    }
    ...
    public function update(StatusPloPliRequest $request, $id)
    {
        $progress = StatusPloPli::findOrFail($id);
    ...
    {
        $target = StatusPloPli::findOrFail($id);
        $target->delete();
