...
use App\Http\Requests\SHG\Kalimantan\SistemInformasiAimsKjgRequest;
use App\Models\SHG\Kalimantan\SistemInformasiAimsKjg;
use Illuminate\Http\Request;

class SistemInformasiAimsKjgController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.SistemInformasiAimsKjg', compact('tabs'));
    }

    public function data()
    {
        return response()->json(SistemInformasiAimsKjg::all());
    }

    public function store(SistemInformasiAimsKjgRequest $request)
    {
        $data = $request->validated();
        $data = SistemInformasiAimsKjg::create($data);
    ...
    public function update(SistemInformasiAimsKjgRequest $request, $id)
    {
        $progress = SistemInformasiAimsKjg::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsKjg::findOrFail($id);
        $target->delete();
