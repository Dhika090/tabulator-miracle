...
class PelatihanAimsKjgController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.PelatihanAimsKjg', compact('tabs'));
    }
    ...
    public function store(PelatihanAimsKjgRequest $request)
    {
        ...
        $data = PelatihanAimsKjg::create($data);
    ...
    public function update(PelatihanAimsKjgRequest $request, $id)
    {
        $progress = PelatihanAimsKjg::findOrFail($id);
    ...
    {
        $target = PelatihanAimsKjg::findOrFail($id);
        $target->delete();
