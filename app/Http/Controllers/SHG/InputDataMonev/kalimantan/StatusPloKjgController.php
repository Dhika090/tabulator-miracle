...
use App\Http\Requests\SHG\Kalimantan\StatusPloKjgRequest;
use App\Models\SHG\Kalimantan\StatusPloKjg;
use Illuminate\Http\Request;

class StatusPloKjgController extends Controller
{
    public function index()
    {
        // return view('SHG.InputDataMonev.kalimantanJawa.StatusPloKjg');
        $tabs = [
            [
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.StatusPloKjg', compact('tabs'));
    }

    public function data()
    {
        return response()->json(StatusPloKjg::all());
    }

    public function store(StatusPloKjgRequest $request)
    {
        $data = $request->validated();
        $data = StatusPloKjg::create($data);
    ...
    public function update(StatusPloKjgRequest $request, $id)
    {
        $progress = StatusPloKjg::findOrFail($id);
    ...
    {
        $target = StatusPloKjg::findOrFail($id);
        $target->delete();
