...
use App\Http\Requests\SHG\Kalimantan\RealisasiAnggaranAiKjgRequest;
use App\Models\SHG\Kalimantan\RealisasiAnggaranAiKjg;
use Illuminate\Http\Request;

class RealisasiAnggaranAiKjg2025Controller extends Controller
{
    public function index()
    {
        // return view('SHG.InputDataMonev.kalimantanJawa.RealisasiAnggaranAIKjg');
        $tabs = [
            [
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.RealisasiAnggaranAIKjg', compact('tabs'));
    }

    public function data()
    {
        return response()->json(RealisasiAnggaranAiKjg::all());
    }

    public function store(RealisasiAnggaranAiKjgRequest $request)
    {
        $data = $request->validated();
        $data = RealisasiAnggaranAiKjg::create($data);
    ...
    public function update(RealisasiAnggaranAiKjgRequest $request, $id)
    {
        $progress = RealisasiAnggaranAiKjg::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiKjg::findOrFail($id);
        $target->delete();
