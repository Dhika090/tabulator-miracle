...
class RealisasiProgressFisikAI2025KjgController extends Controller
{
    ...
    {
        // return view('SHG.InputDataMonev.kalimantanJawa.RealisasiProgressFisikAIKjg');
        $tabs = [
            [
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.RealisasiProgressFisikAIKjg', compact('tabs'));
    }
    ...
    public function store(RealisasiProgressFisikAI2025KjgRequest $request)
    {
        ...
        $data = RealisasiProgressFisikAI2025Kjg::create($data);
    ...
    public function update(RealisasiProgressFisikAI2025KjgRequest $request, $id)
    {
        $progress = RealisasiProgressFisikAI2025Kjg::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAI2025Kjg::findOrFail($id);
        $target->delete();
