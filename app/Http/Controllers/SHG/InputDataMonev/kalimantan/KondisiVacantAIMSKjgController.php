...
use App\Http\Requests\SHG\Kalimantan\KondisiVacantAIMSKjgRequest;
use App\Models\SHG\Kalimantan\KondisiVacantAIMSKjg;
use Illuminate\Http\Request;

class KondisiVacantAIMSKjgController extends Controller
{
    public function index()
    {
        // return view('SHG.InputDataMonev.kalimantanJawa.KondisiVacantFungsiAIMSKjg');
        $tabs = [
            [
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.KondisiVacantFungsiAIMSKjg', compact('tabs'));
    }

    public function data()
    {
        return response()->json(KondisiVacantAIMSKjg::all());
    }

    public function store(KondisiVacantAIMSKjgRequest $request)
    {
        $data = $request->validated();
        $data = KondisiVacantAIMSKjg::create($data);
    ...
    public function update(KondisiVacantAIMSKjgRequest $request, $id)
    {
        $progress = KondisiVacantAIMSKjg::findOrFail($id);
    ...
    {
        $target = KondisiVacantAIMSKjg::findOrFail($id);
        $target->delete();
