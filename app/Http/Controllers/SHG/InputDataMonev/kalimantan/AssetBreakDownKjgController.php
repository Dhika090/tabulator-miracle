...
use App\Http\Requests\SHG\Kalimantan\AssetBreakDownKjgRequest;
use App\Models\SHG\Kalimantan\AssetBreakDownKjg;
use Illuminate\Http\Request;

class AssetBreakDownKjgController extends Controller
{
    public function index()
    {
        // return view('SHG.InputDataMonev.kalimantanJawa.AssetBreakdownKJG');
        $tabs = [
            [
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.AssetBreakdownKJG', compact('tabs'));
    }


    public function data()
    {
        return response()->json(AssetBreakDownKjg::all());
    }

    public function store(AssetBreakDownKjgRequest $request)
    {
        $data = $request->validated();
        $data = AssetBreakDownKjg::create($data);
    ...
    public function update(AssetBreakDownKjgRequest $request, $id)
    {
        $progress = AssetBreakDownKjg::findOrFail($id);
    ...
    {
        $target = AssetBreakDownKjg::findOrFail($id);
        $target->delete();
