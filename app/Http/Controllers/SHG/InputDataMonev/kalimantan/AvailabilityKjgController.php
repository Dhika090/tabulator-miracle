...
class AvailabilityKjgController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.AvailabilityKJG', compact('tabs'));
    }
    ...
    public function store(AvailabilityKjgRequest $request)
    {
        ...
        $data = AvailabilityKjg::create($data);
    ...
    public function update(AvailabilityKjgRequest $request, $id)
    {
        $progress = AvailabilityKjg::findOrFail($id);
    ...
    {
        $target = AvailabilityKjg::findOrFail($id);
        $target->delete();
