...
class MandatoryCertificationKjgController extends Controller
{
    ...
    {
        // return view('SHG.InputDataMonev.kalimantanJawa.MandatoryCertificationKJG');
        $tabs = [
            [
        ...
        return view('SHG.InputDataMonev.kalimantanJawa.MandatoryCertificationKJG', compact('tabs'));
    }
