...
use App\Http\Requests\SHG\PgnGlsm\RealisasiAnggaranAiGLSMRequest;
use App\Http\Requests\SHG\PgnGlsm\RealisasiProgressFisikAiGLSMRequest;
use App\Models\SHG\PgnGlsm\RealisasiAnggaranAiGLSM;
use App\Models\SHG\PgnGlsm\RealisasiProgressFisikAiGLSM;
use Illuminate\Http\Request;

class RealisasiAnggaranAiGlsmController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnGlsm.RealisasiAnggaranAiGLSM', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiGLSMRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiGLSM::create($validated);
    ...
    {
        $TargetPLO = RealisasiAnggaranAiGLSM::all();
        return response()->json($TargetPLO);
    }
    public function update(RealisasiAnggaranAiGLSMRequest $request, $id)
    {
        $progress = RealisasiAnggaranAiGLSM::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiGLSM::findOrFail($id);
        $target->delete();
