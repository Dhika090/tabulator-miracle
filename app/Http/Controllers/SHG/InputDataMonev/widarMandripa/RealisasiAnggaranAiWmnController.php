...
use App\Http\Requests\SHG\WidarMandripa\RealisasiAnggaranAiWmnRequest;
use App\Models\SHG\WidarMandripa\RealisasiAnggaraAiWmn;
use Illuminate\Http\Request;

class RealisasiAnggaranAiWmnController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.widarMandripaNusantara.RealisasiAnggaranAiWMN', compact('tabs'));
    }


    public function data()
    {
        return response()->json(RealisasiAnggaraAiWmn::all());
    }


    public function store(RealisasiAnggaranAiWmnRequest $request)
    {
        $data = $request->validated();
        $data = RealisasiAnggaraAiWmn::create($data);
    ...
    public function update(RealisasiAnggaranAiWmnRequest $request, $id)
    {
        $progress = RealisasiAnggaraAiWmn::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaraAiWmn::findOrFail($id);
        $target->delete();
