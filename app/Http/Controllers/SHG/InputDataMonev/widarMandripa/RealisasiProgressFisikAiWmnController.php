...
use App\Http\Requests\SHG\WidarMandripa\RealisasiProgresFisikAiAiWmnRequest;
use App\Models\SHG\WidarMandripa\RealisasiProgressFisikAiWmn;
use Illuminate\Http\Request;

class RealisasiProgressFisikAiWmnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.widarMandripaNusantara.RealisasiProgressFisikAiWMN', compact('tabs'));
    }
    ...
    public function store(RealisasiProgresFisikAiAiWmnRequest $request)
    {
        ...
        $data = RealisasiProgressFisikAiWmn::create($data);
    ...
    {
        $progress = RealisasiProgressFisikAiWmn::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiWmn::findOrFail($id);
        $target->delete();
