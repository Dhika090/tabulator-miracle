...
use App\Http\Requests\SHG\WidarMandripa\PelatihanAimsWmnRequest;
use App\Models\SHG\WidarMandripa\PelatihanAimsWMN;
use Illuminate\Http\Request;

class PelatihanAimsWmnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.widarMandripaNusantara.PelatihanAimsWMN', compact('tabs'));
    }

    public function data()
    {
        return response()->json(PelatihanAimsWMN::all());
    }

    public function store(PelatihanAimsWmnRequest $request)
    {
        $data = $request->validated();
        $data = PelatihanAimsWMN::create($data);
    ...
    public function update(PelatihanAimsWmnRequest $request, $id)
    {
        $progress = PelatihanAimsWMN::findOrFail($id);
    ...
    {
        $target = PelatihanAimsWMN::findOrFail($id);
        $target->delete();
