...
use App\Http\Requests\SHG\WidarMandripa\PlanMandatoryCertificationRequest;
use App\Models\SHG\WidarMandripa\PlanMandatoryCertification;
use Illuminate\Http\Request;

class PlanMandatoryCertificationController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.widarMandripaNusantara.PlanMandatoryCerfiticationWMN', compact('tabs', 'sertifikasiOptions'));
    }


    public function data()
    {
        return response()->json(PlanMandatoryCertification::all());
    }

    public function store(PlanMandatoryCertificationRequest $request)
    {
        $data = $request->validated();
        $data = PlanMandatoryCertification::create($data);
    ...
    public function update(PlanMandatoryCertificationRequest $request, $id)
    {
        $progress = PlanMandatoryCertification::findOrFail($id);
    ...
    {
        $target = PlanMandatoryCertification::findOrFail($id);
        $target->delete();
