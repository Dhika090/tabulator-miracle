...
use App\Http\Requests\SHG\WidarMandripa\AssetBreakdownWmnRequest;
use App\Models\SHG\WidarMandripa\AssetBreakdownWMN;
...
class AssetBreakdownController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.widarMandripaNusantara.AssetBreakdownWMN', compact('tabs'));
    }


    public function data()
    {
        return response()->json(AssetBreakdownWMN::all());
    }


    public function store(AssetBreakdownWmnRequest $request)
    {
        $data = $request->validated();
        $data = AssetBreakdownWMN::create($data);
    ...
    public function update(AssetBreakdownWmnRequest $request, $id)
    {
        $progress = AssetBreakdownWMN::findOrFail($id);
    ...
    {
        $target = AssetBreakdownWMN::findOrFail($id);
        $target->delete();
