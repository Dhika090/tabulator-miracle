...
use App\Http\Requests\SHG\WidarMandripa\RencanaPemeliharaanBesarWmnRequest;
use App\Models\SHG\WidarMandripa\RencanaPemeliharaanBesarWMN;
use Illuminate\Http\Request;

class RencanaPemeliharaanWmnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.widarMandripaNusantara.RencanaPemeliharaanWMN', compact('tabs'));
    }

    public function data()
    {
        return response()->json(RencanaPemeliharaanBesarWMN::all());
    }

    public function store(RencanaPemeliharaanBesarWmnRequest $request)
    {
        $data = $request->validated();
        $data = RencanaPemeliharaanBesarWMN::create($data);
    ...
    public function update(RencanaPemeliharaanBesarWmnRequest $request, $id)
    {
        $progress = RencanaPemeliharaanBesarWMN::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanBesarWMN::findOrFail($id);
        $target->delete();
