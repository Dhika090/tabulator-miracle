...
use App\Http\Requests\SHG\GagasEnergi\SistemInformasiAimsGEIRequest;
use App\Models\SHG\GagasEnergi\SistemInformasiAimsGEI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
class SistemInformasiAimsGEIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.SistemInformasiAimsGEI', compact('tabs'));
    }

    public function store(SistemInformasiAimsGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsGEI::create($validated);
    ...
    {
           $TargetPLO = SistemInformasiAimsGEI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsGEIRequest $request, $id)
    {
        $progress = SistemInformasiAimsGEI::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsGEI::findOrFail($id);
        $target->delete();
