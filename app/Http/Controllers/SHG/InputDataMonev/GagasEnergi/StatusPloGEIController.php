...
use App\Http\Requests\SHG\GagasEnergi\StatusPloGEIRequest;
use App\Models\SHG\GagasEnergi\StatusPloGEI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusPloGEIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.StatusPloGEI', compact('tabs'));
    }

    public function store(StatusPloGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloGEI::create($validated);
    ...
    public function update(StatusPloGEIRequest $request, $id)
    {
        $progress = StatusPloGEI::findOrFail($id);
    ...
    {
        $target = StatusPloGEI::findOrFail($id);
        $target->delete();
