...
use App\Http\Requests\SHG\GagasEnergi\AirBudgetTaggingGEIRequest;
use App\Models\SHG\GagasEnergi\AirBudgetTaggingGEI;
use Illuminate\Http\Request;

class AirBudgetTaggingGEIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.AirBudgetTaggingGEI', compact('tabs'));
    }

    public function store(AirBudgetTaggingGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AirBudgetTaggingGEI::create($validated);
    ...
    {
        $TargetPLO = AirBudgetTaggingGEI::all();
        return response()->json($TargetPLO);
    }
    public function update(AirBudgetTaggingGEIRequest $request, $id)
    {
        $progress = AirBudgetTaggingGEI::findOrFail($id);
    ...
    {
        $target = AirBudgetTaggingGEI::findOrFail($id);
        $target->delete();
