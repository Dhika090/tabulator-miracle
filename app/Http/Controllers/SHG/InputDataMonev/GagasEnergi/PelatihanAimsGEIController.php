...
use App\Http\Requests\SHG\GagasEnergi\PelatihanAimsGEIRequest;
use App\Models\SHG\GagasEnergi\PelatihanAimsGEI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsGEIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.PelatihanAimsGEI', compact('tabs'));
    }

    public function store(PelatihanAimsGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsGEI::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsGEI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsGEIRequest $request, $id)
    {
        $progress = PelatihanAimsGEI::findOrFail($id);
    ...
    {
        $target = PelatihanAimsGEI::findOrFail($id);
        $target->delete();
