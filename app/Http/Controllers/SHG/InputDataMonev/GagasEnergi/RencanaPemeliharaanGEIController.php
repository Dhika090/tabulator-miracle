...
use App\Http\Requests\SHG\GagasEnergi\RencanaPemeliharaanGEIRequest;
use App\Models\SHG\GagasEnergi\RencanaPemeliharaanGEI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
class RencanaPemeliharaanGEIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.RencanaPemeliharaanGEI', compact('tabs'));
    }

    public function store(RencanaPemeliharaanGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanGEI::create($validated);
    ...
    {
            $TargetPLO = RencanaPemeliharaanGEI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RencanaPemeliharaanGEIRequest $request, $id)
    {
        $progress = RencanaPemeliharaanGEI::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanGEI::findOrFail($id);
        $target->delete();
