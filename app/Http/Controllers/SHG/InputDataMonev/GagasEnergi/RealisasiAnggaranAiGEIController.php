...
use App\Http\Requests\SHG\GagasEnergi\RealisasiAnggaranAiGEIRequest;
...
class RealisasiAnggaranAiGEIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.RealisasiAnggaranAiGEI', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiGEI::create($validated);
    ...
    {
        $TargetPLO = RealisasiAnggaranAiGEI::all();
        return response()->json($TargetPLO);
    }
    public function update(RealisasiAnggaranAiGEIRequest $request, $id)
    {
        $progress = RealisasiAnggaranAiGEI::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiGEI::findOrFail($id);
        $target->delete();
