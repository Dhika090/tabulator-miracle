...
class KondisiVacantAimsGEIController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.gagasEnergi.KondisiVacantFungsiAimsGEI', compact('tabs'));
    }

    public function store(KondisiVacantAimsGEIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsGEI::create($validated);
    ...
    {
        $progress = KondisiVacantAimsGEI::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsGEI::findOrFail($id);
        $target->delete();
