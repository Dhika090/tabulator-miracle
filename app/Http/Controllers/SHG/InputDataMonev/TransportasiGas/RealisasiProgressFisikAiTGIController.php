...
use App\Http\Requests\SHG\TransportasiGas\RealisasiProgressFisikAiTGIRequest;
use App\Models\SHG\TransportasiGas\RealisasiProgressFisikAiTGI;
use Illuminate\Http\Request;

class RealisasiProgressFisikAiTGIController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.TransportasiGas.RealisasiProgressFisikAiTGI', compact('tabs'));
    }

    public function store(RealisasiProgressFisikAiTGIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiProgressFisikAiTGI::create($validated);
    ...
    {
        $TargetPLO = RealisasiProgressFisikAiTGI::all();
        return response()->json($TargetPLO);
    }
    public function update(RealisasiProgressFisikAiTGIRequest $request, $id)
    {
        $progress = RealisasiProgressFisikAiTGI::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiTGI::findOrFail($id);
        $target->delete();
