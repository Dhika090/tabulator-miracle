...
use App\Http\Requests\SHG\TransportasiGas\AvailabilityTGIRequest;
use App\Models\SHG\TransportasiGas\AvailabilityTGI;
use Illuminate\Http\Request;

class AvailabilityTGIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.TransportasiGas.AvailabilityTGI', compact('tabs'));
    }

    public function store(AvailabilityTGIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityTGI::create($validated);
    ...
    {
        $TargetPLO = AvailabilityTGI::all();
        return response()->json($TargetPLO);
    }
    public function update(AvailabilityTGIRequest $request, $id)
    {
        $progress = AvailabilityTGI::findOrFail($id);
    ...
    {
        $target = AvailabilityTGI::findOrFail($id);
        $target->delete();
