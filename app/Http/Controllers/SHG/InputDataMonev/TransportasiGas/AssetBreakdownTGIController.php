...
use App\Http\Requests\SHG\TransportasiGas\AssetBreakdownTGIRequest;
use App\Models\SHG\TransportasiGas\AssetBreakdownTGI;
use Illuminate\Http\Request;

class AssetBreakdownTGIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.TransportasiGas.AssetBreakdownTGI', compact('tabs'));
    }

    public function store(AssetBreakdownTGIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownTGI::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownTGI::all();
        return response()->json($TargetPLO);
    }
    public function update(AssetBreakdownTGIRequest $request, $id)
    {
        $progress = AssetBreakdownTGI::findOrFail($id);
    ...
    {
        $target = AssetBreakdownTGI::findOrFail($id);
        $target->delete();
