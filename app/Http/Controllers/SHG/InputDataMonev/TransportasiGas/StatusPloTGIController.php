...
class StatusPloTGIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.TransportasiGas.StatusPloTGI', compact('tabs'));
    }

    public function store(StatusPloTGIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloTGI::create($validated);
    ...
    {
        $progress = StatusPloTGI::findOrFail($id);
    ...
    {
        $target = StatusPloTGI::findOrFail($id);
        $target->delete();
