...
class RealisasiAnggaranAiTGIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.TransportasiGas.RealisasiAnggaranAiTGI', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiTGIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiTGI::create($validated);
    ...
    {
        $progress = RealisasiAnggaranAiTGI::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiTGI::findOrFail($id);
        $target->delete();
