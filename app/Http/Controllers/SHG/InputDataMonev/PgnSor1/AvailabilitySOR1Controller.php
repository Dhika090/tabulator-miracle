...
use App\Http\Requests\SHG\PgnSor1\AvailabilitySOR1Request;
use App\Models\SHG\PgnSor1\AvailabilitySOR1;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilitySOR1Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.AvailabilitySOR1', compact('tabs'));
    }

    public function store(AvailabilitySOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilitySOR1::create($validated);
    ...
    {
        $TargetPLO = AvailabilitySOR1::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilitySOR1Request $request, $id)
    {
        $progress = AvailabilitySOR1::findOrFail($id);
    ...
    {
        $target = AvailabilitySOR1::findOrFail($id);
        $target->delete();
