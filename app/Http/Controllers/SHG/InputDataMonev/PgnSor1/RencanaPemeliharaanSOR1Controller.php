...
use App\Http\Requests\SHG\PgnSor1\RencanaPemeliharaanSOR1Request;
use App\Models\SHG\PgnSor1\RencanaPemeliharaanSOR1;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanSOR1Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.RencanaPemeliharaanSOR1', compact('tabs'));
    }

    public function store(RencanaPemeliharaanSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanSOR1::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanSOR1::select('*')
    ...
    public function update(RencanaPemeliharaanSOR1Request $request, $id)
    {
        $progress = RencanaPemeliharaanSOR1::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanSOR1::findOrFail($id);
        $target->delete();
