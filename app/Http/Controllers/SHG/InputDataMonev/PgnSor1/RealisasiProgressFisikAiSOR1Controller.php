...
use App\Http\Requests\SHG\PgnSor1\RealisasiProgresFisikAiSOR1Request;
use App\Models\SHG\PgnSor1\RealisasiProgresFisikAiSOR1;
use Illuminate\Http\Request;

class RealisasiProgressFisikAiSOR1Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.RealisasiProgressFisikAISOR1', compact('tabs'));
    }

    public function store(RealisasiProgresFisikAiSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiProgresFisikAiSOR1::create($validated);
    ...
    {
        $TargetPLO = RealisasiProgresFisikAiSOR1::all();
        return response()->json($TargetPLO);
    }
    public function update(RealisasiProgresFisikAiSOR1Request $request, $id)
    {
        $progress = RealisasiProgresFisikAiSOR1::findOrFail($id);
    ...
    {
        $target = RealisasiProgresFisikAiSOR1::findOrFail($id);
        $target->delete();
