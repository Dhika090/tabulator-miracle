...
use App\Http\Requests\SHG\PgnSor1\KondisiVacantAimsSOR1Request;
use App\Models\SHG\PgnSor1\KondisiVacantAimsSOR1;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsSOR1Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.KondisiVacantFungsiAimsSOR1', compact('tabs'));
    }

    public function store(KondisiVacantAimsSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsSOR1::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsSOR1::select('*')
             ->addSelect(DB::raw("TRY_CONVERT(DATE, CONCAT('01-', periode), 120) as periode_date"))
            ->orderBy('periode_date', 'asc')
            ->get();
        return response()->json($TargetPLO);
    }
    public function update(KondisiVacantAimsSOR1Request $request, $id)
    {
        $progress = KondisiVacantAimsSOR1::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsSOR1::findOrFail($id);
        $target->delete();
