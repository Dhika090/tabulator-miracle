...
use App\Http\Requests\SHG\PgnSor1\AirBudgetTaggingSOR1Request;
use App\Models\SHG\PgnSor1\AirBudgetTaggingSOR1;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AirBudgetTaggingSOR1Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.AirBudgetTaggingSOR1', compact('tabs'));
    }

    public function store(AirBudgetTaggingSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AirBudgetTaggingSOR1::create($validated);
    ...
    {
        $TargetPLO = AirBudgetTaggingSOR1::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AirBudgetTaggingSOR1Request $request, $id)
    {
        $progress = AirBudgetTaggingSOR1::findOrFail($id);
    ...
    {
        $target = AirBudgetTaggingSOR1::findOrFail($id);
        $target->delete();
