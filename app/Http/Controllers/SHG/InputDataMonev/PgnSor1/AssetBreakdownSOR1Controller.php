...
class AssetBreakdownSOR1Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.AssetBreakdownSOR1', compact('tabs'));
    }

    public function store(AssetBreakdownSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownSOR1::create($validated);
    ...
    {
        $target = AssetBreakdownSOR1::findOrFail($id);
        $target->delete();
