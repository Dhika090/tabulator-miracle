...
use App\Http\Requests\SHG\PgnSor1\SistemInformasiAimsSOR1Request;
use App\Models\SHG\PgnSor1\SistemInformasiAimsSOR1;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsSOR1Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.SistemInformasiAimsSOR1', compact('tabs'));
    }

    public function store(SistemInformasiAimsSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsSOR1::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsSOR1::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsSOR1Request $request, $id)
    {
        $progress = SistemInformasiAimsSOR1::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsSOR1::findOrFail($id);
        $target->delete();
