...
use App\Http\Requests\SHG\PgnSor1\RealisasiAnggaranAiSOR1Request;
use App\Models\SHG\PgnSor1\RealisasiAnggaranAiSOR1;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealisasiAnggaranAiSOR1Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor1.RealisasiAnggaranAiSOR1', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiSOR1Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiSOR1::create($validated);
    ...
    {
        $TargetPLO = RealisasiAnggaranAiSOR1::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealisasiAnggaranAiSOR1Request $request, $id)
    {
        $progress = RealisasiAnggaranAiSOR1::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiSOR1::findOrFail($id);
        $target->delete();
