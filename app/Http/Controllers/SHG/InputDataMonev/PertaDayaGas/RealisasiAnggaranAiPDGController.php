...
use App\Http\Requests\SHG\Pertadaya\RealisasiAnggaranAiPDGRequest;
use App\Models\SHG\PertaDaya\RealisasiAnggaranAiPDG;
use Illuminate\Http\Request;

class RealisasiAnggaranAiPDGController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PertaDaya.RealisasiAnggaranAiPDG', compact('tabs'));
    }

    public function data()
    {
        return response()->json(RealisasiAnggaranAiPDG::all());
    }

    public function store(RealisasiAnggaranAiPDGRequest $request)
    {
        $data = $request->validated();
        $data = RealisasiAnggaranAiPDG::create($data);
    ...
    public function update(RealisasiAnggaranAiPDGRequest $request, $id)
    {
        $progress = RealisasiAnggaranAiPDG::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiPDG::findOrFail($id);
        $target->delete();
