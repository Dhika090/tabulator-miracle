...
use App\Http\Requests\SHG\Pertadaya\SistemInformasiAimsPDGRequest;
use App\Models\SHG\PertaDaya\SistemInformasiAimsPDG;
use Illuminate\Http\Request;

class SistemInformasiAimsPDGController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PertaDaya.SistemInformasiAimsPDG', compact('tabs'));
    }

    public function data()
    {
        return response()->json(SistemInformasiAimsPDG::all());
    }

    public function store(SistemInformasiAimsPDGRequest $request)
    {
        $data = $request->validated();
        $data = SistemInformasiAimsPDG::create($data);
    ...
    public function update(SistemInformasiAimsPDGRequest $request, $id)
    {
        $progress = SistemInformasiAimsPDG::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsPDG::findOrFail($id);
        $target->delete();
