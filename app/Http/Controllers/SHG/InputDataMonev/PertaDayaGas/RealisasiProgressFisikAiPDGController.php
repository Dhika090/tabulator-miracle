...
use App\Http\Requests\SHG\Pertadaya\RealisasiProgressFisikAiPDGRequest;
use App\Models\SHG\PertaDaya\RealisasiProgressFisikAiPDG;
use Illuminate\Http\Request;

class RealisasiProgressFisikAiPDGController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PertaDaya.RealisasiProgressFisikAiPDG', compact('tabs'));
    }

    public function data()
    {
        return response()->json(RealisasiProgressFisikAiPDG::all());
    }

    public function store(RealisasiProgressFisikAiPDGRequest $request)
    {
        $data = $request->validated();
        $data = RealisasiProgressFisikAiPDG::create($data);
    ...
    public function update(RealisasiProgressFisikAiPDGRequest $request, $id)
    {
        $progress = RealisasiProgressFisikAiPDG::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiPDG::findOrFail($id);
        $target->delete();
