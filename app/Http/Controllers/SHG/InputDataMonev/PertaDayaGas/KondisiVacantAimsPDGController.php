...
class KondisiVacantAimsPDGController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PertaDaya.KondisiVacantFungsiAimsPDG', compact('tabs'));
    }
    ...
    public function store(KondisiVacantAimsPDGRequest $request)
    {
        ...
        $data = KondisiVacantAimsPDG::create($data);
    ...
    public function update(KondisiVacantAimsPDGRequest $request, $id)
    {
        $progress = KondisiVacantAimsPDG::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsPDG::findOrFail($id);
        $target->delete();
