...
use App\Http\Requests\SHG\Pertadaya\RencanaPemeliharaanPDGRequest;
use App\Models\SHG\PertaDaya\RencanaPemeliharaanPDG;
use Illuminate\Http\Request;

class RencanaPemeliharaanPDGController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PertaDaya.RencanaPemeliharaanPDG', compact('tabs'));
    }

    public function data()
    {
        return response()->json(RencanaPemeliharaanPDG::all());
    }

    public function store(RencanaPemeliharaanPDGRequest $request)
    {
        $data = $request->validated();
        $data = RencanaPemeliharaanPDG::create($data);
    ...
    public function update(RencanaPemeliharaanPDGRequest $request, $id)
    {
        $progress = RencanaPemeliharaanPDG::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanPDG::findOrFail($id);
        $target->delete();
