...
class PelatihanAimsPtsgController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.pertaSamtan.PelatihanAimsPTSG', compact('tabs'));
    }
    ...
    public function store(PelatihanAimsPtsgRequest $request)
    {
        ...
        $data = PelatihanAimsPtsg::create($data);
    ...
    public function update(PelatihanAimsPtsgRequest $request, $id)
    {
        $progress = PelatihanAimsPtsg::findOrFail($id);
    ...
    {
        $target = PelatihanAimsPtsg::findOrFail($id);
        $target->delete();
