...
class KondisiVacantAimsPtsgController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.pertaSamtan.KondisiVacantFungsiAimsPTSG', compact('tabs'));
    }
    ...
    public function store(KondisiVacantPTsgRequest $request)
    {
        ...
        $data = KondisiVacantAimsPTsg::create($data);
    ...
    public function update(KondisiVacantPTsgRequest $request, $id)
    {
        $progress = KondisiVacantAimsPTsg::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsPTsg::findOrFail($id);
        $target->delete();
