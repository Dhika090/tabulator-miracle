...
class RealisasiProgressFisikAiPtsgController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.pertaSamtan.RealisasiProgressFisikAIPTSG', compact('tabs'));
    }
    ...
    public function store(RealisasiProgressFisikAiPtsgRequest $request)
    {
        ...
        $data = RealisasiProgressFisikAiPtsg::create($data);
    ...
    public function update(RealisasiProgressFisikAiPtsgRequest $request, $id)
    {
        $progress = RealisasiProgressFisikAiPtsg::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiPtsg::findOrFail($id);
        $target->delete();
