...
class AssetBreakdownPtsgController extends Controller
{
    ...
    public function store(AssetBreakdownPtsgRequest $request)
    {
        ...
        $data = AssetBreakdownPTSG::create($data);
    ...
    public function update(AssetBreakdownPtsgRequest $request, $id)
    {
        $progress = AssetBreakdownPTSG::findOrFail($id);
    ...
    {
        $target = AssetBreakdownPTSG::findOrFail($id);
        $target->delete();
