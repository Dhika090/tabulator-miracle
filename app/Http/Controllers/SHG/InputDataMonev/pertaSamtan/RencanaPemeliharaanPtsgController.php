...
class RencanaPemeliharaanPtsgController extends Controller
{
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.pertaSamtan.RencanaPemeliharaanPtsg2025', compact('tabs'));
    }

    public function data()
    {
        return response()->json(RencanaPemeliharaanPtsg::all());
    }

    public function store(RencanaPemeliharaanPtsgRequest $request)
    {
        $data = $request->validated();
        $data = RencanaPemeliharaanPtsg::create($data);
    ...
    public function update(RencanaPemeliharaanPtsgRequest $request, $id)
    {
        $progress = RencanaPemeliharaanPtsg::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanPtsg::findOrFail($id);
        $target->delete();
