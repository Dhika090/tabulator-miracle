...
use App\Http\Requests\SHG\PgnSor3\RencanaPemeliharaanSOR3Request;
use App\Models\SHG\PgnSor3\RencanaPemeliharaanSOR3;
use Illuminate\Http\Request;

class RencanaPemeliharaanSOR3controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor3.RencanaPemeliharaanSOR3', compact('tabs'));
    }

    public function store(RencanaPemeliharaanSOR3Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanSOR3::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanSOR3::all();
        return response()->json($TargetPLO);
    }
    public function update(RencanaPemeliharaanSOR3Request $request, $id)
    {
        $progress = RencanaPemeliharaanSOR3::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanSOR3::findOrFail($id);
        $target->delete();
