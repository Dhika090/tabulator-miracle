...
class AssetBreakdownSOR3controller extends Controller
{
    ...
    public function store(AssetBreakDownSOR3Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownSOR3::create($validated);
    ...
    {
        $progress = AssetBreakdownSOR3::findOrFail($id);
    ...
    {
        $target = AssetBreakdownSOR3::findOrFail($id);
        $target->delete();
