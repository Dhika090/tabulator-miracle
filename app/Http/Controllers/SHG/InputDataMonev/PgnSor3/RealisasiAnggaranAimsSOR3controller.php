...
class RealisasiAnggaranAimsSOR3controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor3.RealisasiAnggaranAiSOR3', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiSOR3Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiSOR3::create($validated);
    ...
    {
        $progress = RealisasiAnggaranAiSOR3::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiSOR3::findOrFail($id);
        $target->delete();
