...
use App\Http\Requests\SHG\PgnSor3\ReliabilitySOR3Request;
use App\Models\SHG\PgnSor3\ReliabilitySOR3;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class ReliabilitySOR3controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor3.ReliabilitySOR3', compact('tabs'));
    }

    public function store(ReliabilitySOR3Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = ReliabilitySOR3::create($validated);
    ...
    {
        $TargetPLO = ReliabilitySOR3::select('*')
    ...
    public function update(ReliabilitySOR3Request $request, $id)
    {
        $progress = ReliabilitySOR3::findOrFail($id);
    ...
    {
        $target = ReliabilitySOR3::findOrFail($id);
        $target->delete();
