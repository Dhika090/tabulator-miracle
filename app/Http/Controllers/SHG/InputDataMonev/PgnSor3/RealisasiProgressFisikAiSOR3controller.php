...
class RealisasiProgressFisikAiSOR3controller extends Controller
{
 ...
 $tabs = [
        ...
        return view('SHG.InputDataMonev.PgnSor3.RealisasiProgressFisikAISOR3', compact('tabs'));
    }

    public function store(RealisasiProgressFisikAiSOR3Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiProgressFisikAiSOR3::create($validated);
    ...
    {
        $progress = RealisasiProgressFisikAiSOR3::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiSOR3::findOrFail($id);
        $target->delete();
