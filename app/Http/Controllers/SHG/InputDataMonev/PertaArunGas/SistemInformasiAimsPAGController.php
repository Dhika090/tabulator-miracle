...
class SistemInformasiAimsPAGController extends Controller
{
    ...
    public function store(SistemInformasiAimsPAGRequest $request)
    {
        $data = $request->validated();
        $data = SistemInformasiAimsPAG::create($data);
    ...
    public function update(SistemInformasiAimsPAGRequest $request, $id)
    {
        $progress = SistemInformasiAimsPAG::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsPAG::findOrFail($id);
        $target->delete();
