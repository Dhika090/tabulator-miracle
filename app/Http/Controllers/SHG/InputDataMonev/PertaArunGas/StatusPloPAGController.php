...
use App\Http\Requests\SHG\PertaArun\StatusPloPAGRequest;
use App\Models\SHG\PertaArun\StatusPloPAG;
use Illuminate\Http\Request;

class StatusPloPAGController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('SHG.InputDataMonev.PertaArun.StatusPloPAG', compact('tabs'));
    }


    public function data()
    {
        return response()->json(StatusPloPAG::all());
    }


    public function store(StatusPloPAGRequest $request)
    {
        $data = $request->validated();
        $data = StatusPloPAG::create($data);
    ...
    public function update(StatusPloPAGRequest $request, $id)
    {
        $progress = StatusPloPAG::findOrFail($id);
    ...
    {
        $target = StatusPloPAG::findOrFail($id);
        $target->delete();
