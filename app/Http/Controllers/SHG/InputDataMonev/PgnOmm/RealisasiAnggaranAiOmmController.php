...
use App\Http\Requests\SHG\PgnOmm\RealisasiAnggaranAiOmmRequest;
use App\Models\SHG\PgnOmm\RealisasiAnggaranAiOmm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealisasiAnggaranAiOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.RealisasiAnggaranAiOMM', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiOmm::create($validated);
    ...
    {
        $TargetPLO = RealisasiAnggaranAiOmm::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealisasiAnggaranAiOmmRequest $request, $id)
    {
        $progress = RealisasiAnggaranAiOmm::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiOmm::findOrFail($id);
        $target->delete();
