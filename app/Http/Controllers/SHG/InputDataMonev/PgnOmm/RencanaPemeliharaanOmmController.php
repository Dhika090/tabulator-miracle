...
use App\Http\Requests\SHG\PgnOmm\RencanaPemeliharaanOmmRequest;
use App\Models\SHG\PgnOmm\RencanaPemeliharaanAimsOmm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.RencanaPemeliharaanOMM', compact('tabs'));
    }

    public function store(RencanaPemeliharaanOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanAimsOmm::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanAimsOmm::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RencanaPemeliharaanOmmRequest $request, $id)
    {
        $progress = RencanaPemeliharaanAimsOmm::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanAimsOmm::findOrFail($id);
        $target->delete();
