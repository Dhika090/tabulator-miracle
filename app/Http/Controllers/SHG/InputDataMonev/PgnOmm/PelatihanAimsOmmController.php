...
use App\Http\Requests\SHG\PgnOmm\PelatihanAimsOmmRequest;
use App\Models\SHG\PgnOmm\PelatihanAimsOmm;
use Illuminate\Http\Request;

class PelatihanAimsOmmController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.PelatihanAimsOMM', compact('tabs'));
    }

    public function store(PelatihanAimsOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsOmm::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsOmm::all();
        return response()->json($TargetPLO);
    }
    public function update(PelatihanAimsOmmRequest $request, $id)
    {
        $progress = PelatihanAimsOmm::findOrFail($id);
    ...
    {
        $target = PelatihanAimsOmm::findOrFail($id);
        $target->delete();
