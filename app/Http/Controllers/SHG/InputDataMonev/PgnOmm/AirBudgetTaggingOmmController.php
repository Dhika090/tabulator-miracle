...
use App\Http\Requests\SHG\PgnOmm\AirBudgetTaggingOmmRequest;
use App\Models\SHG\PgnOmm\AirBudgetTaggingOmm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AirBudgetTaggingOmmController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.AirBudgetTaggingOMM', compact('tabs'));
    }

    public function store(AirBudgetTaggingOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AirBudgetTaggingOmm::create($validated);
    ...
    {
        $TargetPLO = AirBudgetTaggingOmm::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AirBudgetTaggingOmmRequest $request, $id)
    {
        $progress = AirBudgetTaggingOmm::findOrFail($id);
    ...
    {
        $target = AirBudgetTaggingOmm::findOrFail($id);
        $target->delete();
