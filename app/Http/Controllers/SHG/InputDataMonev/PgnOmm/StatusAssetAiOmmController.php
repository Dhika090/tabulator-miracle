...
class StatusAssetAiOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->wantsJson()) {
            $TargetPLO = StatusAssetAiOmm::all();
        ...
        return view('SHG.InputDataMonev.PgnOmm.StatusAssetAiOMM', compact('tabs', 'companies'));
    }
    ...
    public function store(StatusAssetAiOmmRequest $request)
    {
        $data = $request->validated();
        $data = StatusAssetAiOmm::create($data);
    ...
    public function update(StatusAssetAiOmmRequest $request, $id)
    {
        $progress = StatusAssetAiOmm::findOrFail($id);
    ...
    {
        $target = StatusAssetAiOmm::findOrFail($id);
        $target->delete();
