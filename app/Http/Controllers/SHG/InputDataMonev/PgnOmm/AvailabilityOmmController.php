...
use App\Http\Requests\SHG\PgnOmm\AvailabilityOmmRequest;
use App\Models\SHG\PgnOmm\AvailabilityOmm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.AvailabilityOMM', compact('tabs'));
    }

    public function store(AvailabilityOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityOmm::create($validated);
    ...
    public function update(AvailabilityOmmRequest $request, $id)
    {
        $progress = AvailabilityOmm::findOrFail($id);
    ...
    {
        $target = AvailabilityOmm::findOrFail($id);
        $target->delete();
