...
use App\Http\Requests\SHG\PgnOmm\StatusPloOmmRequest;
use App\Models\SHG\PgnOmm\StatusPloOmm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class StatusPloOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.StatusPloOMM', compact('tabs'));
    }

    public function store(StatusPloOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = StatusPloOmm::create($validated);
    ...
    {
        // $TargetPLO = StatusPloOmm::all();
        // return response()->json($TargetPLO);
        $TargetPLO = StatusPloOmm::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(StatusPloOmmRequest $request, $id)
    {
        $progress = StatusPloOmm::findOrFail($id);
    ...
    {
        $target = StatusPloOmm::findOrFail($id);
        $target->delete();
