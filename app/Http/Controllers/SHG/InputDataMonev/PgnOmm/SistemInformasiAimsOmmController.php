...
use App\Http\Requests\SHG\PgnOmm\SistemInformasiAimsOmmRequest;
use App\Models\SHG\PgnOmm\SistemInformasiAimsOmm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.SistemInformasiAimsOMM', compact('tabs'));
    }

    public function store(SistemInformasiAimsOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsOmm::create($validated);
    ...
    {
           $TargetPLO = SistemInformasiAimsOmm::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsOmmRequest $request, $id)
    {
        $progress = SistemInformasiAimsOmm::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsOmm::findOrFail($id);
        $target->delete();
