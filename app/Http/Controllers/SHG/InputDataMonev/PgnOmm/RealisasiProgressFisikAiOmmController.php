...
use App\Http\Requests\SHG\PgnOmm\RealisasiProgressFisikAiOmmRequest;
use App\Models\SHG\PgnOmm\RealisasiProgressFisikAiOmm;
use Illuminate\Http\Request;

class RealisasiProgressFisikAiOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.RealisasiProgressFisikAIOMM', compact('tabs'));
    }

    public function store(RealisasiProgressFisikAiOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiProgressFisikAiOmm::create($validated);
    ...
    {
        $TargetPLO = RealisasiProgressFisikAiOmm::all();
        return response()->json($TargetPLO);
    }
    public function update(RealisasiProgressFisikAiOmmRequest $request, $id)
    {
        $progress = RealisasiProgressFisikAiOmm::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiOmm::findOrFail($id);
        $target->delete();
