...
class ReliabilityOmmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnOmm.ReliabilityOMM', compact('tabs'));
    }

    public function store(ReliabilityOmmRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = ReliabilityOmm::create($validated);
    ...
    {
        $progress = ReliabilityOmm::findOrFail($id);
    ...
    {
        $target = ReliabilityOmm::findOrFail($id);
        $target->delete();
