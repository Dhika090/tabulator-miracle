...
use App\Http\Requests\SHG\SakaEnergi\MandatoryCertificationSakaRequest;
use App\Models\SHG\SakaEnergi\MandatoryCertificationSAKA;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class MandatoryCertificationSakaController extends Controller
{

    public function index(Request $request)
    {
        if ($request->wantsJson()) {
            $TargetPLO = MandatoryCertificationSAKA::all();
        ...
        return view('SHG.InputDataMonev.SakaEnergi.MandatoryCertificationSaka', compact('tabs', 'sertifikasiOptions'));
    }


    public function store(MandatoryCertificationSakaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = MandatoryCertificationSAKA::create($validated);
    ...
    {
        $TargetPLO = MandatoryCertificationSAKA::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(MandatoryCertificationSakaRequest $request, $id)
    {
        $progress = MandatoryCertificationSAKA::findOrFail($id);
    ...
    {
        $target = MandatoryCertificationSAKA::findOrFail($id);
        $target->delete();
