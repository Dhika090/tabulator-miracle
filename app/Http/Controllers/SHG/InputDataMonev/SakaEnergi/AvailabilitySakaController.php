...
use App\Http\Requests\SHG\SakaEnergi\AvailabilitySakaRequest;
use App\Models\SHG\SakaEnergi\AvailabilitySAKA;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilitySakaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.SakaEnergi.AvailabilitySAKA', compact('tabs'));
    }

    public function store(AvailabilitySakaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilitySAKA::create($validated);
    ...
    {
        $TargetPLO = AvailabilitySAKA::select('*')
    ...
    public function update(AvailabilitySakaRequest $request, $id)
    {
        $progress = AvailabilitySAKA::findOrFail($id);
    ...
    {
        $target = AvailabilitySAKA::findOrFail($id);
        $target->delete();
