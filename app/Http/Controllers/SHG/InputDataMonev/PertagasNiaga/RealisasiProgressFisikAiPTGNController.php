...
use App\Http\Requests\SHG\PertagasNiaga\RealisasiProgressFisikAiPTGNRequest;
use App\Models\SHG\PertagasNiaga\RealisasiProgressFisikAiPTGN;
use Illuminate\Http\Request;

class RealisasiProgressFisikAiPTGNController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.pertagasNiaga.RealisasiProgressFisikAIPTGN', compact('tabs'));
    }

    public function store(RealisasiProgressFisikAiPTGNRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiProgressFisikAiPTGN::create($validated);
    ...
    {
        $TargetPLO = RealisasiProgressFisikAiPTGN::all();
        return response()->json($TargetPLO);
    }
    public function update(RealisasiProgressFisikAiPTGNRequest $request, $id)
    {
        $progress = RealisasiProgressFisikAiPTGN::findOrFail($id);
    ...
    {
        $target = RealisasiProgressFisikAiPTGN::findOrFail($id);
        $target->delete();
