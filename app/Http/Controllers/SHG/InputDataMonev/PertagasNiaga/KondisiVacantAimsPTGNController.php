...
use App\Http\Requests\SHG\PertagasNiaga\KondisiVacantAimsPTGNRequest;
use App\Models\SHG\PertagasNiaga\KondisiVacantAimsPTGN;
use Illuminate\Http\Request;

class KondisiVacantAimsPTGNController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.pertagasNiaga.KondisiVacantFungsiAimsPTGN', compact('tabs'));
    }


    public function store(KondisiVacantAimsPTGNRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsPTGN::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsPTGN::all();
        return response()->json($TargetPLO);
    }
    public function update(KondisiVacantAimsPTGNRequest $request, $id)
    {
        $progress = KondisiVacantAimsPTGN::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsPTGN::findOrFail($id);
        $target->delete();
