...
class AssetBreakdownPTGNController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.pertagasNiaga.AssetBreakdownPTGN', compact('tabs'));
    }

    public function store(AssetBreakdownPTGNRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownPTGN::create($validated);
    ...
    {
        $progress = AssetBreakdownPTGN::findOrFail($id);
    ...
    {
        $target = AssetBreakdownPTGN::findOrFail($id);
        $target->delete();
