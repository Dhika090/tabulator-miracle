...
use App\Http\Requests\SHG\PertagasNiaga\RencanaPemeliharaanPTGNRequest;
use App\Models\SHG\PertagasNiaga\RencanaPemeliharaanPTGN;
use Illuminate\Http\Request;

class RencanaPemeliharaanPTGNController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.pertagasNiaga.RencanaPemeliharaanPTGN', compact('tabs'));
    }


    public function store(RencanaPemeliharaanPTGNRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanPTGN::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanPTGN::all();
        return response()->json($TargetPLO);
    }
    public function update(RencanaPemeliharaanPTGNRequest $request, $id)
    {
        $progress = RencanaPemeliharaanPTGN::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanPTGN::findOrFail($id);
        $target->delete();
