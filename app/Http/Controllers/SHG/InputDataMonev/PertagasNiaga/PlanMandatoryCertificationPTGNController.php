...
use App\Http\Requests\SHG\PertagasNiaga\PlanMandatoryCertificationPTGNRequest;
use App\Models\SHG\PertagasNiaga\PlanMandatoryCertificationPTGN;
use Illuminate\Http\Request;

class PlanMandatoryCertificationPTGNController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.pertagasNiaga.PlanMandatoryCerfiticationPTGN', compact('tabs', 'sertifikasiOptions'));
    }


    public function data()
    {
        return response()->json(PlanMandatoryCertificationPTGN::all());
    }


    public function store(PlanMandatoryCertificationPTGNRequest $request)
    {
        $data = $request->validated();
        $data = PlanMandatoryCertificationPTGN::create($data);
    ...
    public function update(PlanMandatoryCertificationPTGNRequest $request, $id)
    {
        $progress = PlanMandatoryCertificationPTGN::findOrFail($id);
    ...
    {
        $target = PlanMandatoryCertificationPTGN::findOrFail($id);
        $target->delete();
