...
use App\Http\Requests\SHG\PgnSor2\RealisasiAnggaranAiSOR2Request;
use App\Models\SHG\PgnSor2\RealisasiAnggaranAiSOR2;
...
class RealisasiAnggaranAiSOR2controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.RealisasiAnggaranAiSOR2', compact('tabs'));
    }

    public function store(RealisasiAnggaranAiSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiAnggaranAiSOR2::create($validated);
    ...
    {
        $TargetPLO = RealisasiAnggaranAiSOR2::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealisasiAnggaranAiSOR2Request $request, $id)
    {
        $progress = RealisasiAnggaranAiSOR2::findOrFail($id);
    ...
    {
        $target = RealisasiAnggaranAiSOR2::findOrFail($id);
        $target->delete();
