...
use App\Http\Requests\SHG\PgnSor2\AssetBreakDownSOR2Request;
use App\Models\SHG\PgnSor2\AssetBreakdownAiSOR2;
use Illuminate\Http\Request;

class AssetBreakdownSOR2Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.AssetBreakdownSOR2', compact('tabs'));
    }

    public function store(AssetBreakDownSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownAiSOR2::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownAiSOR2::all();
        return response()->json($TargetPLO);
    }
    public function update(AssetBreakDownSOR2Request $request, $id)
    {
        $progress = AssetBreakdownAiSOR2::findOrFail($id);
    ...
    {
        $target = AssetBreakdownAiSOR2::findOrFail($id);
        $target->delete();
