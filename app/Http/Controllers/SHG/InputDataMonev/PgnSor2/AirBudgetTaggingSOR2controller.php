...
use App\Http\Requests\SHG\PgnSor2\AirBudgetTaggingSOR2Request;
use App\Models\SHG\PgnSor2\AirBudgetTaggingAiSOR2;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AirBudgetTaggingSOR2controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.AirBudgetTaggingSOR2', compact('tabs'));
    }

    public function store(AirBudgetTaggingSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AirBudgetTaggingAiSOR2::create($validated);
    ...
    {
        $TargetPLO = AirBudgetTaggingAiSOR2::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AirBudgetTaggingSOR2Request $request, $id)
    {
        $progress = AirBudgetTaggingAiSOR2::findOrFail($id);
    ...
    {
        $target = AirBudgetTaggingAiSOR2::findOrFail($id);
        $target->delete();
