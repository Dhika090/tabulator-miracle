...
use App\Http\Requests\SHG\PgnSor2\SistemInformasiAimsSOR2Request;
use App\Models\SHG\PgnSor2\SistemInformasiAimsSOR2;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsSOR2Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.SistemInformasiAimsSOR2', compact('tabs'));
    }


    public function store(SistemInformasiAimsSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsSOR2::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsSOR2::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsSOR2Request $request, $id)
    {
        $progress = SistemInformasiAimsSOR2::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsSOR2::findOrFail($id);
        $target->delete();
