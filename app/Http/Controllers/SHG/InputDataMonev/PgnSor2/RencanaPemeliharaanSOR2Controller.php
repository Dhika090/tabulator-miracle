...
class RencanaPemeliharaanSOR2Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.RencanaPemeliharaanSOR2', compact('tabs'));
    }

    public function store(RencanaPemeliharaanSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanSOR2::create($validated);
    ...
    {
        $progress = RencanaPemeliharaanSOR2::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanSOR2::findOrFail($id);
        $target->delete();
