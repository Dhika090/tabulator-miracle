...
use App\Http\Requests\SHG\PgnSor2\KondisiVacantAimsSOR2Request;
use App\Models\SHG\PgnSor2\KondisiVacantAimsSOR2;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsSOR2Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.KondisiVacantFungsiAimsSOR2', compact('tabs'));
    }

    public function store(KondisiVacantAimsSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsSOR2::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsSOR2::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(KondisiVacantAimsSOR2Request $request, $id)
    {
        $progress = KondisiVacantAimsSOR2::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsSOR2::findOrFail($id);
        $target->delete();
