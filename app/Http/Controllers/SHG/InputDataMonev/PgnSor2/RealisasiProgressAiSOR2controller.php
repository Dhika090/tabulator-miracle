...
class RealisasiProgressAiSOR2controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.RealisasiProgressFisikAISOR2', compact('tabs'));
    }

    public function store(RealisasiProgressAiSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealisasiProgressAiSOR2::create($validated);
    ...
    {
        $progress = RealisasiProgressAiSOR2::findOrFail($id);
    ...
    {
        $target = RealisasiProgressAiSOR2::findOrFail($id);
        $target->delete();
