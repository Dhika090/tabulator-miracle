...
class AvailabilitySOR2controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.AvailabilitySOR2', compact('tabs'));
    }

    public function store(AvailabilitySOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilitySOR2::create($validated);
    ...
    {
        $progress = AvailabilitySOR2::findOrFail($id);
    ...
    {
        $target = AvailabilitySOR2::findOrFail($id);
        $target->delete();
