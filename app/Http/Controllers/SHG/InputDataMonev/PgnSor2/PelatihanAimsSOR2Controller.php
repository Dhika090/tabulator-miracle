...
class PelatihanAimsSOR2Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.InputDataMonev.PgnSor2.PelatihanAimsSOR2', compact('tabs'));
    }

    public function store(PelatihanAimsSOR2Request $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsSOR2::create($validated);
    ...
    {
        $progress = PelatihanAimsSOR2::findOrFail($id);
    ...
    {
        $target = PelatihanAimsSOR2::findOrFail($id);
        $target->delete();
