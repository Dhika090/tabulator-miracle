...
class TargetMandatoryCertificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHG.TargetMandatoryCertification', compact('sertifikasiOptions'));
    }
    ...
    {
        $TargetPLO = SHGMandatoryCertification::select('*')
    ...
    public function update(SHGMandatoryCertificationRequest $request, $id)
    {
        $progress = SHGMandatoryCertification::findOrFail($id);
    ...
    {
        $target = SHGMandatoryCertification::findOrFail($id);
        $target->delete();
