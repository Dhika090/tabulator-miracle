...
use App\Http\Requests\SHPNRE\Karaha\SistemInformasiAimsKarahaRequest;
use App\Models\SHPNRE\Karaha\SistemInformasiAimsKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsKarahaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.SistemInformasiAimsKaraha', compact('tabs'));
    }

    public function store(SistemInformasiAimsKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsKaraha::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsKaraha::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsKarahaRequest $request, $id)
    {
        $progress = SistemInformasiAimsKaraha::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsKaraha::findOrFail($id);
        $target->delete();
