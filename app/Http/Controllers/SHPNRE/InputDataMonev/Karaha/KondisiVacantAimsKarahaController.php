...
use App\Http\Requests\SHPNRE\Karaha\KondisiVacantAimsKarahaRequest;
use App\Models\SHPNRE\Karaha\KondisiVacantAimsKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsKarahaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.KondisiVacantFungsiAimsKaraha', compact('tabs'));
    }

    public function store(KondisiVacantAimsKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsKaraha::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsKaraha::select('*')
    ...
    public function update(KondisiVacantAimsKarahaRequest $request, $id)
    {
        $progress = KondisiVacantAimsKaraha::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsKaraha::findOrFail($id);
        $target->delete();
