...
use App\Http\Requests\SHPNRE\Karaha\AssetBreakDownKarahaRequest;
use App\Models\SHPNRE\Karaha\AssetBreakdownKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakDownKarahaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.AssetBreakdownKaraha', compact('tabs'));
    }

    public function store(AssetBreakDownKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownKaraha::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownKaraha::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakDownKarahaRequest $request, $id)
    {
        $progress = AssetBreakdownKaraha::findOrFail($id);
    ...
    {
        $target = AssetBreakdownKaraha::findOrFail($id);
        $target->delete();
