...
use App\Http\Requests\SHPNRE\Karaha\RealProgFisikAiKarahaRequest;
use App\Models\SHPNRE\Karaha\RealProgFisikAiKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiKarahaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.RealProgFisikAiKaraha', compact('tabs'));
    }

    public function store(RealProgFisikAiKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiKaraha::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiKaraha::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiKarahaRequest $request, $id)
    {
        $progress = RealProgFisikAiKaraha::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiKaraha::findOrFail($id);
        $target->delete();
