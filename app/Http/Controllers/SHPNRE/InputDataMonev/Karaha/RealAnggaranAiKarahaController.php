...
use App\Http\Requests\SHPNRE\Karaha\RealAnggaranAiKarahaRequest;
use App\Models\SHPNRE\Karaha\RealAnggaranAiKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiKarahaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.RealAnggaranAiKaraha', compact('tabs'));
    }

    public function store(RealAnggaranAiKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiKaraha::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiKaraha::select('*')
    ...
    public function update(RealAnggaranAiKarahaRequest $request, $id)
    {
        $progress = RealAnggaranAiKaraha::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiKaraha::findOrFail($id);
        $target->delete();
