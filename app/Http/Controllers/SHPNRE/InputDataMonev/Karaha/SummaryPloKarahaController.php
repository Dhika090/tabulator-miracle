...
use App\Http\Requests\SHPNRE\Karaha\SummaryPloKarahaRequest;
use App\Models\SHPNRE\Karaha\SummaryPloKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloKarahaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.SummaryPloKaraha', compact('tabs'));
    }

    public function store(SummaryPloKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPloKaraha::create($validated);
    ...
    {
        $TargetPLO = SummaryPloKaraha::select('*')
    ...
    public function update(SummaryPloKarahaRequest $request, $id)
    {
        $progress = SummaryPloKaraha::findOrFail($id);
    ...
    {
        $target = SummaryPloKaraha::findOrFail($id);
        $target->delete();
