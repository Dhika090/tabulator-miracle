...
use App\Http\Requests\SHPNRE\Karaha\AvailabilityKarahaRequest;
use App\Models\SHPNRE\Karaha\AvailabilityKaraha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityKarahaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Karaha.AvailabilityKaraha', compact('tabs'));
    }

    public function store(AvailabilityKarahaRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityKaraha::create($validated);
    ...
    {
        $TargetPLO = AvailabilityKaraha::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityKarahaRequest $request, $id)
    {
        $progress = AvailabilityKaraha::findOrFail($id);
    ...
    {
        $target = AvailabilityKaraha::findOrFail($id);
        $target->delete();
