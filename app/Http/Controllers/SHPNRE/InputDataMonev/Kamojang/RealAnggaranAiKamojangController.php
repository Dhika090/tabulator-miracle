...
use App\Http\Requests\SHPNRE\Kamojang\RealAnggaranAiKamojangRequest;
use App\Models\SHPNRE\Kamojang\RealAnggaranAiKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.RealAnggaranAiKamojang', compact('tabs'));
    }

    public function store(RealAnggaranAiKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiKamojang::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiKamojang::select('*')
    ...
    public function update(RealAnggaranAiKamojangRequest $request, $id)
    {
        $progress = RealAnggaranAiKamojang::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiKamojang::findOrFail($id);
        $target->delete();
