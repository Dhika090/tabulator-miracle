...
use App\Http\Requests\SHPNRE\Kamojang\SistemInformasiAimsKamojangRequest;
use App\Models\SHPNRE\Kamojang\SistemInformasiAimsKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.SistemInformasiAimsKamojang', compact('tabs'));
    }

    public function store(SistemInformasiAimsKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsKamojang::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsKamojang::select('*')
    ...
    public function update(SistemInformasiAimsKamojang $request, $id)
    {
        $progress = SistemInformasiAimsKamojang::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsKamojang::findOrFail($id);
        $target->delete();
