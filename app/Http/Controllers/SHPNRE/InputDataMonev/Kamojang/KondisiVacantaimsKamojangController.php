...
use App\Http\Requests\SHPNRE\Kamojang\KondisiVacantAimsKamojangRequest;
use App\Models\SHPNRE\Kamojang\KondisiVacantAimsKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantaimsKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.KondisiVacantAimsKamojang', compact('tabs'));
    }

    public function store(KondisiVacantAimsKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsKamojang::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsKamojang::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(KondisiVacantAimsKamojangRequest $request, $id)
    {
        $progress = KondisiVacantAimsKamojang::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsKamojang::findOrFail($id);
        $target->delete();
