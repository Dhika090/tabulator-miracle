...
use App\Http\Requests\SHPNRE\Kamojang\PelatihanAimsKamojangRequest;
use App\Models\SHPNRE\Kamojang\PelatihanAimsKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.PelatihanAimsKamojang', compact('tabs'));
    }

    public function store(PelatihanAimsKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsKamojang::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsKamojang::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsKamojangRequest $request, $id)
    {
        $progress = PelatihanAimsKamojang::findOrFail($id);
    ...
    {
        $target = PelatihanAimsKamojang::findOrFail($id);
        $target->delete();
