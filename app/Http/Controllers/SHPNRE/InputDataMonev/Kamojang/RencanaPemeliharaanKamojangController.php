...
use App\Http\Requests\SHPNRE\Kamojang\RencanaPemeliharaanKamojangRequest;
use App\Models\SHPNRE\Kamojang\RencanaPemeliharaanKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.RencanaPemeliharaanKamojang', compact('tabs'));
    }

    public function store(RencanaPemeliharaanKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanKamojang::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanKamojang::select('*')
    ...
    public function update(RencanaPemeliharaanKamojangRequest $request, $id)
    {
        $progress = RencanaPemeliharaanKamojang::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanKamojang::findOrFail($id);
        $target->delete();
