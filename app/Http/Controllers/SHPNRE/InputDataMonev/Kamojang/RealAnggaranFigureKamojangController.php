...
use App\Http\Requests\SHPNRE\Kamojang\RealAnggaranFigureKamojangRequest;
use App\Models\SHPNRE\Kamojang\RealAnggaranFigureKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigureKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.RealAnggaranFigureKamojang', compact('tabs'));
    }

    public function store(RealAnggaranFigureKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranFigureKamojang::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranFigureKamojang::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranFigureKamojangRequest $request, $id)
    {
        $progress = RealAnggaranFigureKamojang::findOrFail($id);
    ...
    {
        $target = RealAnggaranFigureKamojang::findOrFail($id);
        $target->delete();
