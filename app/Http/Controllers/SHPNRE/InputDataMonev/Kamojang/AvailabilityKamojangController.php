...
use App\Http\Requests\SHPNRE\Kamojang\AvailabilityKamojangRequest;
use App\Models\SHPNRE\Kamojang\AvailabilityKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.AvailabilityKamojang', compact('tabs'));
    }

    public function store(AvailabilityKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityKamojang::create($validated);
    ...
    {
        $TargetPLO = AvailabilityKamojang::select('*')
    ...
    public function update(AvailabilityKamojangRequest $request, $id)
    {
        $progress = AvailabilityKamojang::findOrFail($id);
    ...
    {
        $target = AvailabilityKamojang::findOrFail($id);
        $target->delete();
