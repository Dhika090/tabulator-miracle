...
use App\Http\Requests\SHPNRE\Kamojang\AssetBreakdownKamojangRequest;
use App\Models\SHPNRE\Kamojang\AssetBreakdownKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.AssetBreakdownKamojang', compact('tabs'));
    }

    public function store(AssetBreakdownKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownKamojang::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownKamojang::select('*')
    ...
    public function update(AssetBreakdownKamojangRequest $request, $id)
    {
        $progress = AssetBreakdownKamojang::findOrFail($id);
    ...
    {
        $target = AssetBreakdownKamojang::findOrFail($id);
        $target->delete();
