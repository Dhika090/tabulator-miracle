...
use App\Http\Requests\SHPNRE\Kamojang\RealProgFisikAiKamojangRequest;
use App\Models\SHPNRE\Kamojang\RealProgFisikAiKamojang;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiKamojangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Kamojang.RealProgFisikAiKamojang', compact('tabs'));
    }

    public function store(RealProgFisikAiKamojangRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiKamojang::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiKamojang::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiKamojangRequest $request, $id)
    {
        $progress = RealProgFisikAiKamojang::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiKamojang::findOrFail($id);
        $target->delete();
