...
use App\Http\Requests\SHPNRE\PPI\SistemInformasiAimsPPIRequest;
use App\Models\SHPNRE\PPI\SistemInformasiAimsPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.SistemInformasiAimsPPI', compact('tabs'));
    }

    public function store(SistemInformasiAimsPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsPPI::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsPPI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiAimsPPIRequest $request, $id)
    {
        $progress = SistemInformasiAimsPPI::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsPPI::findOrFail($id);
        $target->delete();
