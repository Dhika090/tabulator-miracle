...
use App\Http\Requests\SHPNRE\PPI\RencanaPemeliharaanPPIRequest;
use App\Models\SHPNRE\PPI\RencanaPemeliharaanPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.RencanaPemeliharaanPPI', compact('tabs'));
    }

    public function store(RencanaPemeliharaanPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanPPI::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanPPI::select('*')
    ...
    public function update(RencanaPemeliharaanPPIRequest $request, $id)
    {
        $progress = RencanaPemeliharaanPPI::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanPPI::findOrFail($id);
        $target->delete();
