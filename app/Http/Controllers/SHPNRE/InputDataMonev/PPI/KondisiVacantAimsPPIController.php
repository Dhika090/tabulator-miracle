...
use App\Http\Requests\SHPNRE\PPI\KondisiVacantAimsPPIRequest;
use App\Models\SHPNRE\PPI\KondisiVacantAimsPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.KondisiVacantAimsPPI', compact('tabs'));
    }

    public function store(KondisiVacantAimsPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsPPI::create($validated);
    ...
    public function update(KondisiVacantAimsPPIRequest $request, $id)
    {
        $progress = KondisiVacantAimsPPI::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsPPI::findOrFail($id);
        $target->delete();
