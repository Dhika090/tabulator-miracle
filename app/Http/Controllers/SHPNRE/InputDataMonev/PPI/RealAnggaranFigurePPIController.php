...
use App\Http\Requests\SHPNRE\PPI\RealAnggaranFigurePPIRequest;
use App\Models\SHPNRE\PPI\RealAnggaranFigurePPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigurePPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.RealAnggaranFigurePPI', compact('tabs'));
    }

    public function store(RealAnggaranFigurePPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranFigurePPI::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranFigurePPI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranFigurePPIRequest $request, $id)
    {
        $progress = RealAnggaranFigurePPI::findOrFail($id);
    ...
    {
        $target = RealAnggaranFigurePPI::findOrFail($id);
        $target->delete();
