...
use App\Http\Requests\SHPNRE\PPI\RealProgFisikAiPPIRequest;
use App\Models\SHPNRE\PPI\RealProgFisikAiPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.RealProgFisikAiPPI', compact('tabs'));
    }

    public function store(RealProgFisikAiPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiPPI::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiPPI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiPPIRequest $request, $id)
    {
        $progress = RealProgFisikAiPPI::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiPPI::findOrFail($id);
        $target->delete();
