...
use App\Http\Requests\SHPNRE\PPI\PelatihanAimsPPIRequest;
use App\Models\SHPNRE\PPI\PelatihanAimsPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.PelatihanAimsPPI', compact('tabs'));
    }

    public function store(PelatihanAimsPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsPPI::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsPPI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsPPIRequest $request, $id)
    {
        $progress = PelatihanAimsPPI::findOrFail($id);
    ...
    {
        $target = PelatihanAimsPPI::findOrFail($id);
        $target->delete();
