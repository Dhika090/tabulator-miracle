...
use App\Http\Requests\SHPNRE\PPI\AssetBreakdownPPIRequest;
use App\Models\SHPNRE\PPI\AssetBreakdownPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.AssetBreakdownPPI', compact('tabs'));
    }

    public function store(AssetBreakdownPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownPPI::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownPPI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakdownPPIRequest $request, $id)
    {
        $progress = AssetBreakdownPPI::findOrFail($id);
    ...
    {
        $target = AssetBreakdownPPI::findOrFail($id);
        $target->delete();
