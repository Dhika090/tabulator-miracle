...
use App\Http\Requests\SHPNRE\PPI\RealAnggaranAiPPIRequest;
use App\Models\SHPNRE\PPI\RealAnggaranAiPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.RealAnggaranAiPPI', compact('tabs'));
    }

    public function store(RealAnggaranAiPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiPPI::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiPPI::select('*')
    ...
    public function update(RealAnggaranAiPPIRequest $request, $id)
    {
        $progress = RealAnggaranAiPPI::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiPPI::findOrFail($id);
        $target->delete();
