...
use App\Http\Requests\SHPNRE\PPI\SummaryPloPPIRequest;
use App\Models\SHPNRE\PPI\SummaryPloPPI;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloPPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.PPI.SummaryPloPPI', compact('tabs'));
    }

    public function store(SummaryPloPPIRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPloPPI::create($validated);
    ...
    {
        $TargetPLO = SummaryPloPPI::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SummaryPloPPIRequest $request, $id)
    {
        $progress = SummaryPloPPI::findOrFail($id);
    ...
    {
        $target = SummaryPloPPI::findOrFail($id);
        $target->delete();
