...
use App\Http\Requests\SHPNRE\Jawa1Power\AssetBreakdownJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\AssetBreakdownAiJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.AssetBreakdownJawa1Power', compact('tabs'));
    }

    public function store(AssetBreakdownJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownAiJawa1Power::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownAiJawa1Power::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakdownJawa1PowerRequest $request, $id)
    {
        $progress = AssetBreakdownAiJawa1Power::findOrFail($id);
    ...
    {
        $target = AssetBreakdownAiJawa1Power::findOrFail($id);
        $target->delete();
