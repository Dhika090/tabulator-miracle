...
use App\Http\Requests\SHPNRE\Jawa1Power\RealProgFisikAiJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\RealProgFisikAiJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.RealProgFisikAiJawa1Power', compact('tabs'));
    }

    public function store(RealProgFisikAiJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiJawa1Power::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiJawa1Power::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiJawa1PowerRequest $request, $id)
    {
        $progress = RealProgFisikAiJawa1Power::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiJawa1Power::findOrFail($id);
        $target->delete();
