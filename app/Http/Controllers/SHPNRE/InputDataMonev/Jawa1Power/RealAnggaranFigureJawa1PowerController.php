...
use App\Http\Requests\SHPNRE\Jawa1Power\RealAnggaranFigureJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\RealAnggaranFigureJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigureJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.RealAnggaranFigureJawa1Power', compact('tabs'));
    }

    public function store(RealAnggaranFigureJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranFigureJawa1Power::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranFigureJawa1Power::select('*')
    ...
    public function update(RealAnggaranFigureJawa1PowerRequest $request, $id)
    {
        $progress = RealAnggaranFigureJawa1Power::findOrFail($id);
    ...
    {
        $target = RealAnggaranFigureJawa1Power::findOrFail($id);
        $target->delete();
