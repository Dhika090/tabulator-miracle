...
use App\Http\Requests\SHPNRE\Jawa1Power\AvailabilityJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\AvailabilityJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.AvailabilityJawa1Power', compact('tabs'));
    }

    public function store(AvailabilityJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityJawa1Power::create($validated);
    ...
    {
        $TargetPLO = AvailabilityJawa1Power::select('*')
    ...
    public function update(AvailabilityJawa1PowerRequest $request, $id)
    {
        $progress = AvailabilityJawa1Power::findOrFail($id);
    ...
    {
        $target = AvailabilityJawa1Power::findOrFail($id);
        $target->delete();
