...
use App\Http\Requests\SHPNRE\Jawa1Power\KondisiVacantAimsJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\KondisiVacantAimsJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.KondisiVacantAimsJawa1Power', compact('tabs'));
    }

    public function store(KondisiVacantAimsJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsJawa1Power::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsJawa1Power::select('*')
    ...
    public function update(KondisiVacantAimsJawa1PowerRequest $request, $id)
    {
        $progress = KondisiVacantAimsJawa1Power::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsJawa1Power::findOrFail($id);
        $target->delete();
