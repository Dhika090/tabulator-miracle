...
use App\Http\Requests\SHPNRE\Jawa1Power\SummaryPloJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\SummaryPlolJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.SummaryPloJawa1Power', compact('tabs'));
    }

    public function store(SummaryPloJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPlolJawa1Power::create($validated);
    ...
    {
        $TargetPLO = SummaryPlolJawa1Power::select('*')
    ...
    public function update(SummaryPloJawa1PowerRequest $request, $id)
    {
        $progress = SummaryPlolJawa1Power::findOrFail($id);
    ...
    {
        $target = SummaryPlolJawa1Power::findOrFail($id);
        $target->delete();
