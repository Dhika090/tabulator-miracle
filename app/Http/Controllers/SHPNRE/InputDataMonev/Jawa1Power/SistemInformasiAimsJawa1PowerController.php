...
use App\Http\Requests\SHPNRE\Jawa1Power\SistemInformasiAimsJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\SistemInformasiAimsJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.SistemInformasiAimsJawa1Power', compact('tabs'));
    }

    public function store(SistemInformasiAimsJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsJawa1Power::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsJawa1Power::select('*')
    ...
    public function update(SistemInformasiAimsJawa1PowerRequest $request, $id)
    {
        $progress = SistemInformasiAimsJawa1Power::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsJawa1Power::findOrFail($id);
        $target->delete();
