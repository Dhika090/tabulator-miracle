...
use App\Http\Requests\SHPNRE\Jawa1Power\RealAnggaranAiJawa1PowerRequest;
use App\Models\SHPNRE\Jawa1Power\RealAnggaranAiJawa1Power;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiJawa1PowerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Power.RealAnggaranAiJawa1Power', compact('tabs'));
    }

    public function store(RealAnggaranAiJawa1PowerRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiJawa1Power::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiJawa1Power::select('*')
    ...
    public function update(RealAnggaranAiJawa1PowerRequest $request, $id)
    {
        $progress = RealAnggaranAiJawa1Power::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiJawa1Power::findOrFail($id);
        $target->delete();
