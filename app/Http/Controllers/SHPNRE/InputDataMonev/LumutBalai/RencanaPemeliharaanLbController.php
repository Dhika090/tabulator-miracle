...
use App\Http\Requests\SHPNRE\LumutBalai\RencanaPemeliharaanLbRequest;
use App\Models\SHPNRE\LumutBalai\RencanaPemeliharaanLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.RencanaPemeliharaanLB', compact('tabs'));
    }


    public function store(RencanaPemeliharaanLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanLB::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanLB::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RencanaPemeliharaanLbRequest $request, $id)
    {
        $progress = RencanaPemeliharaanLB::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanLB::findOrFail($id);
        $target->delete();
