...
use App\Http\Requests\SHPNRE\LumutBalai\SistemInformasiLbRequest;
use App\Models\SHPNRE\LumutBalai\SistemInformasiAimsLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.SistemInformasiAimsLB', compact('tabs'));
    }


    public function store(SistemInformasiLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsLB::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsLB::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SistemInformasiLbRequest $request, $id)
    {
        $progress = SistemInformasiAimsLB::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsLB::findOrFail($id);
        $target->delete();
