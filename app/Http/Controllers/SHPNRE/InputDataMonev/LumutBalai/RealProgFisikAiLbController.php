...
use App\Http\Requests\SHPNRE\LumutBalai\RealProgFisikAiLbRequest;
use App\Models\SHPNRE\LumutBalai\RealProgFisikAiLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.RealProgFisikAiLB', compact('tabs'));
    }

    public function store(RealProgFisikAiLBRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiLB::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiLB::select('*')
    ...
    public function update(RealProgFisikAiLbRequest $request, $id)
    {
        $progress = RealProgFisikAiLB::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiLB::findOrFail($id);
        $target->delete();
