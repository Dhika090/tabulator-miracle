...
use App\Http\Requests\SHPNRE\LumutBalai\KondisiVacantAimsLbRequest;
use App\Models\SHPNRE\LumutBalai\KondisiVacantAimsLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsLbController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.KondisiVacantFungsiAimsLB', compact('tabs'));
    }

    public function store(KondisiVacantAimsLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsLB::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsLB::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(KondisiVacantAimsLbRequest $request, $id)
    {
        $progress = KondisiVacantAimsLB::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsLB::findOrFail($id);
        $target->delete();
