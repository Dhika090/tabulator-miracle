...
use App\Http\Requests\SHPNRE\LumutBalai\AvailabilityLbRequest;
use App\Models\SHPNRE\LumutBalai\AvailabilityLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.AvailabilityLB', compact('tabs'));
    }

    public function store(AvailabilityLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityLB::create($validated);
    ...
    {
        $TargetPLO = AvailabilityLB::select('*')
    ...
    public function update(AvailabilityLbRequest $request, $id)
    {
        $progress = AvailabilityLB::findOrFail($id);
    ...
    {
        $target = AvailabilityLB::findOrFail($id);
        $target->delete();
