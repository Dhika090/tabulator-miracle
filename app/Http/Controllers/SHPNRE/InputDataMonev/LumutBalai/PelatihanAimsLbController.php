...
use App\Http\Requests\SHPNRE\LumutBalai\PelatihanAimsLbRequest;
use App\Models\SHPNRE\LumutBalai\PelatihanAimsLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.PelatihanAimsLB', compact('tabs'));
    }

    public function store(PelatihanAimsLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsLB::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsLB::select('*')
    ...
    public function update(PelatihanAimsLbRequest $request, $id)
    {
        $progress = PelatihanAimsLB::findOrFail($id);
    ...
    {
        $target = PelatihanAimsLB::findOrFail($id);
        $target->delete();
