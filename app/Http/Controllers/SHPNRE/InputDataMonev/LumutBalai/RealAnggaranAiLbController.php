...
use App\Http\Requests\SHPNRE\LumutBalai\RealAnggaranAiLbRequest;
use App\Models\SHPNRE\LumutBalai\RealAnggaranAiLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.RealAnggaranAiLB', compact('tabs'));
    }

    public function store(RealAnggaranAiLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiLB::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiLB::select('*')
    ...
    public function update(RealAnggaranAiLbRequest $request, $id)
    {
        $progress = RealAnggaranAiLB::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiLB::findOrFail($id);
        $target->delete();
