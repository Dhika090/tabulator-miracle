...
use App\Http\Requests\SHPNRE\LumutBalai\RealAnggaranFigureLbRequest;
use App\Models\SHPNRE\LumutBalai\RealAnggaranFigureLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigureLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.RealAnggaranFigureLB', compact('tabs'));
    }

    public function store(RealAnggaranFigureLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranFigureLB::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranFigureLB::select('*')
    ...
    public function update(RealAnggaranFigureLbRequest $request, $id)
    {
        $progress = RealAnggaranFigureLB::findOrFail($id);
    ...
    {
        $target = RealAnggaranFigureLB::findOrFail($id);
        $target->delete();
