...
use App\Http\Requests\SHPNRE\LumutBalai\SummaryPloLbRequest;
use App\Models\SHPNRE\LumutBalai\SummaryPloLB;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloLbController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.LumutBalai.SummaryPlo', compact('tabs'));
    }

    public function store(SummaryPloLbRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPloLB::create($validated);
    ...
    public function update(SummaryPloLbRequest $request, $id)
    {
        $progress = SummaryPloLB::findOrFail($id);
    ...
    {
        $target = SummaryPloLB::findOrFail($id);
        $target->delete();
