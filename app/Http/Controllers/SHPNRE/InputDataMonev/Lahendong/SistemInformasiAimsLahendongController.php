...
use App\Http\Requests\SHPNRE\Lahendong\SistemInformasiLahendongRequest;
use App\Models\SHPNRE\Lahendong\SistemInformasiAimsLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.SistemInformasiAimsLahendong', compact('tabs'));
    }

    public function store(SistemInformasiLahendongRequest $request)
    {
    ...
    {
        $TargetPLO = SistemInformasiAimsLahendong::select('*')
    ...
    public function update(SistemInformasiLahendongRequest $request, $id)
    {
        $progress = SistemInformasiAimsLahendong::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsLahendong::findOrFail($id);
        $target->delete();
