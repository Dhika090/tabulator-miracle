...
use App\Http\Requests\SHPNRE\Lahendong\RealAnggaranAiLahendongRequest;
use App\Models\SHPNRE\Lahendong\RealAnggaranAiLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.RealAnggaranAiLahendong', compact('tabs'));
    }

    public function store(RealAnggaranAiLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiLahendong::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiLahendong::select('*')
    ...
    public function update(RealAnggaranAiLahendongRequest $request, $id)
    {
        $progress = RealAnggaranAiLahendong::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiLahendong::findOrFail($id);
        $target->delete();
