...
use App\Http\Requests\SHPNRE\Lahendong\AvailabilityLahendongRequest;
use App\Models\SHPNRE\Lahendong\AvailabilityLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.AvailabilityLahendong', compact('tabs'));
    }

    public function store(AvailabilityLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityLahendong::create($validated);
    ...
    {
        $TargetPLO = AvailabilityLahendong::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityLahendongRequest $request, $id)
    {
        $progress = AvailabilityLahendong::findOrFail($id);
    ...
    {
        $target = AvailabilityLahendong::findOrFail($id);
        $target->delete();
