...
use App\Http\Requests\SHPNRE\Lahendong\MandatoryCertificationLahendongRequest;
use App\Models\SHPNRE\Lahendong\MandatoryCertificationLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class MandatoryCertificationLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.MandatoryCertificationLahendong', compact('tabs', 'sertifikasiOptions'));
    }

    public function store(MandatoryCertificationLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = MandatoryCertificationLahendong::create($validated);
    ...
    {
        $TargetPLO = MandatoryCertificationLahendong::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(MandatoryCertificationLahendongRequest $request, $id)
    {
        $progress = MandatoryCertificationLahendong::findOrFail($id);
    ...
    {
        $target = MandatoryCertificationLahendong::findOrFail($id);
        $target->delete();
