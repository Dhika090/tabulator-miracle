...
use App\Http\Requests\SHPNRE\Lahendong\PelatihanAimsLahendongRequest;
use App\Models\SHPNRE\Lahendong\PelatihanAimsLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.PelatihanAimsLahendong', compact('tabs'));
    }

    public function store(PelatihanAimsLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsLahendong::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsLahendong::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsLahendongRequest $request, $id)
    {
        $progress = PelatihanAimsLahendong::findOrFail($id);
    ...
    {
        $target = PelatihanAimsLahendong::findOrFail($id);
        $target->delete();
