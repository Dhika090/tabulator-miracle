...
use App\Http\Requests\SHPNRE\Lahendong\SummaryPloLahendongRequest;
use App\Models\SHPNRE\Lahendong\SummaryPloLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.SummaryPloLahendong', compact('tabs'));
    }

    public function store(SummaryPloLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPloLahendong::create($validated);
    ...
    {
        $TargetPLO = SummaryPloLahendong::select('*')
    ...
    public function update(SummaryPloLahendongRequest $request, $id)
    {
        $progress = SummaryPloLahendong::findOrFail($id);
    ...
    {
        $target = SummaryPloLahendong::findOrFail($id);
        $target->delete();
