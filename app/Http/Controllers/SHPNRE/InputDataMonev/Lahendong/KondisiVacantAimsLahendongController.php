...
use App\Http\Requests\SHPNRE\Lahendong\KondisiVacantAimsLahendongRequest;
use App\Models\SHPNRE\Lahendong\KondisiVacantAimsLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.KondisiVacantFungsiAimsLahendong', compact('tabs'));
    }

    public function store(KondisiVacantAimsLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsLahendong::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsLahendong::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(KondisiVacantAimsLahendongRequest $request, $id)
    {
        $progress = KondisiVacantAimsLahendong::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsLahendong::findOrFail($id);
        $target->delete();
