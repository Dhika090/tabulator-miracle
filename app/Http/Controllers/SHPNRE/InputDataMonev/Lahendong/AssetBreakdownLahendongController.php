...
use App\Http\Requests\SHPNRE\Lahendong\AssetBreakdownLahendongRequest;
use App\Models\SHPNRE\Lahendong\AssetBreakdownLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownLahendongController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.AssetBreakdownLahendong', compact('tabs'));
    }

    public function store(AssetBreakdownLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownLahendong::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownLahendong::select('*')
    ...
    public function update(AssetBreakdownLahendongRequest $request, $id)
    {
        $progress = AssetBreakdownLahendong::findOrFail($id);
    ...
    {
        $target = AssetBreakdownLahendong::findOrFail($id);
        $target->delete();
