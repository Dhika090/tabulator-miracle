...
use App\Http\Requests\SHPNRE\Lahendong\RealAnggaranFigureLahendongRequest;
use App\Models\SHPNRE\Lahendong\RealAnggaanFigureLahendong;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigureLahendongController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Lahendong.RealAnggaranFigureLahendong', compact('tabs'));
    }

    public function store(RealAnggaranFigureLahendongRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaanFigureLahendong::create($validated);
    ...
    {
        $TargetPLO = RealAnggaanFigureLahendong::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealAnggaranFigureLahendongRequest $request, $id)
    {
        $progress = RealAnggaanFigureLahendong::findOrFail($id);
    ...
    {
        $target = RealAnggaanFigureLahendong::findOrFail($id);
        $target->delete();
