...
use App\Http\Requests\SHPNRE\Jawa1Regas\RealProgFisikAiJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\RealProgFisikAiJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.RealProgFisikAiJawa1Regas', compact('tabs'));
    }

    public function store(RealProgFisikAiJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiJawa1Regas::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RealProgFisikAiJawa1RegasRequest $request, $id)
    {
        $progress = RealProgFisikAiJawa1Regas::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiJawa1Regas::findOrFail($id);
        $target->delete();
