...
use App\Http\Requests\SHPNRE\Jawa1Regas\AvailabilityJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\AvailabilityJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AvailabilityJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.AvailabilityJawa1Regas', compact('tabs'));
    }

    public function store(AvailabilityJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AvailabilityJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = AvailabilityJawa1Regas::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AvailabilityJawa1RegasRequest $request, $id)
    {
        $progress = AvailabilityJawa1Regas::findOrFail($id);
    ...
    {
        $target = AvailabilityJawa1Regas::findOrFail($id);
        $target->delete();
