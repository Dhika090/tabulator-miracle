...
use App\Http\Requests\SHPNRE\Jawa1Regas\RealAnggaranFigureJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\RealAnggaranFigureJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranFigureJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.RealAnggaranFigureJawa1Regas', compact('tabs'));
    }

    public function store(RealAnggaranFigureJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranFigureJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranFigureJawa1Regas::select('*')
    ...
    public function update(RealAnggaranFigureJawa1RegasRequest $request, $id)
    {
        $progress = RealAnggaranFigureJawa1Regas::findOrFail($id);
    ...
    {
        $target = RealAnggaranFigureJawa1Regas::findOrFail($id);
        $target->delete();
