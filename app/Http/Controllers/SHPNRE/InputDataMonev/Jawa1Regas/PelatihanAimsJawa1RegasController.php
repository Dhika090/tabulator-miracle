...
use App\Http\Requests\SHPNRE\Jawa1Regas\PelatihanAimsJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\PelatihanAimsJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.PelatihanAimsJawa1Regas', compact('tabs'));
    }

    public function store(PelatihanAimsJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsJawa1Regas::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsJawa1RegasRequest $request, $id)
    {
        $progress = PelatihanAimsJawa1Regas::findOrFail($id);
    ...
    {
        $target = PelatihanAimsJawa1Regas::findOrFail($id);
        $target->delete();
