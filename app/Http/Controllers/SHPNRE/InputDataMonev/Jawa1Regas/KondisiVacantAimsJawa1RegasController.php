...
use App\Http\Requests\SHPNRE\Jawa1Regas\KondisiVacantAimsJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\KondisiVacantAimsJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantAimsJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.KondisiVacantAimsJawa1Regas', compact('tabs'));
    }

    public function store(KondisiVacantAimsJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsJawa1Regas::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(KondisiVacantAimsJawa1RegasRequest $request, $id)
    {
        $progress = KondisiVacantAimsJawa1Regas::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsJawa1Regas::findOrFail($id);
        $target->delete();
