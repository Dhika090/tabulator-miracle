...
use App\Http\Requests\SHPNRE\Jawa1Regas\SummaryPloJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\SummaryPloJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.SummaryPloJawa1Regas', compact('tabs'));
    }

    public function store(SummaryPloJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPloJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = SummaryPloJawa1Regas::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SummaryPloJawa1RegasRequest $request, $id)
    {
        $progress = SummaryPloJawa1Regas::findOrFail($id);
    ...
    {
        $target = SummaryPloJawa1Regas::findOrFail($id);
        $target->delete();
