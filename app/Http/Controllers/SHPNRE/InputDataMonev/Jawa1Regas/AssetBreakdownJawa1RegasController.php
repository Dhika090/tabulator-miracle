...
use App\Http\Requests\SHPNRE\Jawa1Regas\AssetBreakdownJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\AssetBreakdownJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.AssetBreakdownJawa1Regas', compact('tabs'));
    }

    public function store(AssetBreakdownJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownJawa1Regas::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakdownJawa1RegasRequest $request, $id)
    {
        $progress = AssetBreakdownJawa1Regas::findOrFail($id);
    ...
    {
        $target = AssetBreakdownJawa1Regas::findOrFail($id);
        $target->delete();
