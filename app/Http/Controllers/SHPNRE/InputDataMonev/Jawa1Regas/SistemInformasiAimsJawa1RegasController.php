...
use App\Http\Requests\SHPNRE\Jawa1Regas\SistemInformasiAimsJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\SistemInformasiAimsJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SistemInformasiAimsJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.SistemInformasiAimsJawa1Regas', compact('tabs'));
    }

    public function store(SistemInformasiAimsJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SistemInformasiAimsJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = SistemInformasiAimsJawa1Regas::select('*')
    ...
    public function update(SistemInformasiAimsJawa1RegasRequest $request, $id)
    {
        $progress = SistemInformasiAimsJawa1Regas::findOrFail($id);
    ...
    {
        $target = SistemInformasiAimsJawa1Regas::findOrFail($id);
        $target->delete();
