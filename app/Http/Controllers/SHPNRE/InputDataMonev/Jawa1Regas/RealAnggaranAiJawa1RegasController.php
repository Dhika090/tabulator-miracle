...
use App\Http\Requests\SHPNRE\Jawa1Regas\RealAnggaranAiJawa1RegasRequest;
use App\Models\SHPNRE\Jawa1Regas\RealAnggaranAiJawa1Regas;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiJawa1RegasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Jawa1Regas.RealAnggaranAiJawa1Regas', compact('tabs'));
    }

    public function store(RealAnggaranAiJawa1RegasRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiJawa1Regas::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiJawa1Regas::select('*')
    ...
    public function update(RealAnggaranAiJawa1RegasRequest $request, $id)
    {
        $progress = RealAnggaranAiJawa1Regas::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiJawa1Regas::findOrFail($id);
        $target->delete();
