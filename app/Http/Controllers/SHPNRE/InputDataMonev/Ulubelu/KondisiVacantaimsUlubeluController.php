...
use App\Http\Requests\SHPNRE\Ulubelu\KondisiVacantAimsUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\KondisiVacantAimsUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KondisiVacantaimsUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.KondisiVacantAimsUlubelu', compact('tabs'));
    }

    public function store(KondisiVacantAimsUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = KondisiVacantAimsUlubelu::create($validated);
    ...
    {
        $TargetPLO = KondisiVacantAimsUlubelu::select('*')
    ...
    public function update(KondisiVacantAimsUlubeluRequest $request, $id)
    {
        $progress = KondisiVacantAimsUlubelu::findOrFail($id);
    ...
    {
        $target = KondisiVacantAimsUlubelu::findOrFail($id);
        $target->delete();
