...
use App\Http\Requests\SHPNRE\Ulubelu\AssetBreakdownUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\AssetBreakdownUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class AssetBreakdownUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.AssetBreakdownUlubelu', compact('tabs'));
    }

    public function store(AssetBreakdownUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = AssetBreakdownUlubelu::create($validated);
    ...
    {
        $TargetPLO = AssetBreakdownUlubelu::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(AssetBreakdownUlubeluRequest $request, $id)
    {
        $progress = AssetBreakdownUlubelu::findOrFail($id);
    ...
    {
        $target = AssetBreakdownUlubelu::findOrFail($id);
        $target->delete();
