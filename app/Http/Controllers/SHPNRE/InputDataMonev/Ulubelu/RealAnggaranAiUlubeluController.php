...
use App\Http\Requests\SHPNRE\Ulubelu\RealAnggaranAiUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\RealAnggaranAiUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealAnggaranAiUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.RealAnggaranAiUlubelu', compact('tabs'));
    }

    public function store(RealAnggaranAiUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealAnggaranAiUlubelu::create($validated);
    ...
    {
        $TargetPLO = RealAnggaranAiUlubelu::select('*')
    ...
    public function update(RealAnggaranAiUlubeluRequest $request, $id)
    {
        $progress = RealAnggaranAiUlubelu::findOrFail($id);
    ...
    {
        $target = RealAnggaranAiUlubelu::findOrFail($id);
        $target->delete();
