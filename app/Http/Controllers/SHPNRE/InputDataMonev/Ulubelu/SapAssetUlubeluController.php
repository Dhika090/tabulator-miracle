...
use App\Http\Requests\SHPNRE\Ulubelu\SapAssetUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\SapAssetUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SapAssetUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.SapAssetUlubelu', compact('tabs'));
    }

    public function store(SapAssetUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SapAssetUlubelu::create($validated);
    ...
    {
        $TargetPLO = SapAssetUlubelu::select('*')
    ...
    public function update(SapAssetUlubeluRequest $request, $id)
    {
        $progress = SapAssetUlubelu::findOrFail($id);
    ...
    {
        $target = SapAssetUlubelu::findOrFail($id);
        $target->delete();
