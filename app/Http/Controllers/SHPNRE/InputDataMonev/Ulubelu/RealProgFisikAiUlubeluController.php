...
use App\Http\Requests\SHPNRE\Ulubelu\RealProgFisikAiUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\RealProgFisikAiUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RealProgFisikAiUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.RealProgFisikAiUlubelu', compact('tabs'));
    }

    public function store(RealProgFisikAiUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RealProgFisikAiUlubelu::create($validated);
    ...
    {
        $TargetPLO = RealProgFisikAiUlubelu::select('*')
    ...
    public function update(RealProgFisikAiUlubeluRequest $request, $id)
    {
        $progress = RealProgFisikAiUlubelu::findOrFail($id);
    ...
    {
        $target = RealProgFisikAiUlubelu::findOrFail($id);
        $target->delete();
