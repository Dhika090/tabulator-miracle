...
use App\Http\Requests\SHPNRE\Ulubelu\SummaryPloUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\SummaryPloUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SummaryPloUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.SummaryPloUlubelu', compact('tabs'));
    }

    public function store(SummaryPloUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = SummaryPloUlubelu::create($validated);
    ...
    {
        $TargetPLO = SummaryPloUlubelu::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(SummaryPloUlubeluRequest $request, $id)
    {
        $progress = SummaryPloUlubelu::findOrFail($id);
    ...
    {
        $target = SummaryPloUlubelu::findOrFail($id);
        $target->delete();
