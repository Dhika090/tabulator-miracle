...
use App\Http\Requests\SHPNRE\Ulubelu\RencanaPemeliharaanUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\RencanaPemeliharaanUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class RencanaPemeliharaanUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.RencanaPemeliharaanUlubelu', compact('tabs'));
    }

    public function store(RencanaPemeliharaanUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = RencanaPemeliharaanUlubelu::create($validated);
    ...
    {
        $TargetPLO = RencanaPemeliharaanUlubelu::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(RencanaPemeliharaanUlubeluRequest $request, $id)
    {
        $progress = RencanaPemeliharaanUlubelu::findOrFail($id);
    ...
    {
        $target = RencanaPemeliharaanUlubelu::findOrFail($id);
        $target->delete();
