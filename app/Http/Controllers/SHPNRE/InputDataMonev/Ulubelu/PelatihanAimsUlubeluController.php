...
use App\Http\Requests\SHPNRE\Ulubelu\PelatihanAimsUlubeluRequest;
use App\Models\SHPNRE\Ulubelu\PelatihanAimsUlubelu;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PelatihanAimsUlubeluController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SHPNRE.InputDataMonev.Ulubelu.PelatihanAimsUlubelu', compact('tabs'));
    }

    public function store(PelatihanAimsUlubeluRequest $request)
    {
        $validated = $request->validated();
        $TargetPLO = PelatihanAimsUlubelu::create($validated);
    ...
    {
        $TargetPLO = PelatihanAimsUlubelu::select('*')
            ->addSelect(DB::raw("
    ...
    public function update(PelatihanAimsUlubeluRequest $request, $id)
    {
        $progress = PelatihanAimsUlubelu::findOrFail($id);
    ...
    {
        $target = PelatihanAimsUlubelu::findOrFail($id);
        $target->delete();
