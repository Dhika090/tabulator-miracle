...
class MandatoryCertificationPtgRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'jumlah_sertifikasi_terbit' => 'nullable|integer|min:0',
            'jumlah_learning_hours' => 'nullable|integer|min:0',
        ];
    }
}
