...
class AirBudgetTaggingPAGRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'jumlah_aset_critical_sece' => 'nullable|numeric',
            'jumlah_aset_critical_pce' => 'nullable|numeric',
            'jumlah_aset_important' => 'nullable|numeric',
            'jumlah_aset_secondary' => 'nullable|numeric',
        ];
    }
}
