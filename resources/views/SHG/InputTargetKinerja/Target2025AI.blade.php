...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title mb-3">Target KPI 2025 AI</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <form id="createForm">
                ...
                <input type="number" name="penurunan_kumulatif_low_integrity" required><br>

                <label>Penurunan Kumulatif Medium Integrity:</label>
                <input type="number" name="penurunan_kumulatif_medium_integrity" required><br><br>
    ...
    @push('scripts')
        ...
        <script>
            ...
            const routeMap = {
                "target-2025-ai": "{{ route('target-2025-ai.data') }}",
            };
            ...
            document.addEventListener("DOMContentLoaded", function() {
                loadTabData("target-2025-ai");
                localStorage.setItem("currentTab", "target-2025-ai  ");
            });
        </script>
