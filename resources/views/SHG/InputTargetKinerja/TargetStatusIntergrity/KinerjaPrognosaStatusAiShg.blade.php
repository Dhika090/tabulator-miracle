    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Pelatihan AIMS cilacap</h5>
        ...
        <div class="modal-content">
            ...
            <form id="createForm">
                ...
                <div>
                    ...
                    <input type="number" name="low_sece" id="low_sece">
                </div>

                <div>
                    <label>Low PCE</label>
                    <input type="number" name="low_pce" id="low_pce">
                </div>

                <div>
                    <label>Low Important</label>
                    <input type="number" name="low_important" id="low_important">
                </div>

                <div>
                    <label>Med SecE</label>
                    <input type="number" name="med_sece" id="med_sece">
                </div>

                <div>
                    <label>Med PCE</label>
                    <input type="number" name="med_pce" id="med_pce">
                </div>

                <div>
                    <label>Med Important</label>
                    <input type="number" name="med_important" id="med_important">
                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`shg-prognosa-status-ai/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/kinerja/shg-prognosa-status-ai/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["shg-prognosa-status-ai"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "shg-prognosa-status-ai.xlsx", {
                        sheetName: "shg-prognosa-status-ai",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`shg-prognosa-status-ai/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("shg-prognosa-status-ai", {
                        ...
                        body: JSON.stringify({
                            ...
                            low_sece: data.low_sece,
                            low_pce: data.low_pce,
                            low_important: data.low_important,
                            med_sece: data.med_sece,
                            med_pce: data.med_pce,
                            med_important: data.med_important,
                            jumlah: data.jumlah,
                            high: data.high
                        })
                    })
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData(`${BASE_URL}/monev/shg/kinerja/shg-prognosa-status-ai/data`);
                            this.reset();
                            closeModal();
                        } else {
