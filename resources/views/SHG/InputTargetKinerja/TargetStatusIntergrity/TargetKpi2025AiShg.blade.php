    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Target KPI 2025 AI</h5>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`shg-target-kpi-2025-ai/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            document.getElementById("search-input").addEventListener("input", function(e) {
                ...
                table.setFilter([
                    [{
                        ...
                        {
                            field: "penurunan_kumulatif_low_integrity",
                            type: "like",
                            value: keyword
                        },
                        {
                            field: "penurunan_kumulatif_medium_integrity",
                            type: "like",
                            value: keyword
                        }
                    ]
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/kinerja/shg-target-kpi-2025-ai/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["shg-target-kpi-2025-ai"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "shg-target-kpi-2025-ai.xlsx", {
                        sheetName: "shg-target-kpi-2025-ai",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`shg-target-kpi-2025-ai/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("shg-target-kpi-2025-ai", {
                        ...
                        body: JSON.stringify({
                            ...
                            penurunan_kumulatif_low_integrity: data.penurunan_kumulatif_low_integrity,
                            penurunan_kumulatif_medium_integrity: data.penurunan_kumulatif_medium_integrity
                        })
                    })
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData(`${BASE_URL}/monev/shg/kinerja/shg-target-kpi-2025-ai/data`);
                            this.reset();
                            closeModal();
                        } else {
