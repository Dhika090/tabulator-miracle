...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">KPI Mndatory Certification Summary</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>KPI Mndatory Certification Summary</h3>
            <form id="createForm">
                <input type="hidden" name="id" id="form-id">
                <div>
                    <label>Periode</label>
                    <input type="month" name="periode" id="periode" disabled>
                </div>

                <div>
                    <label>Subholding</label>
                    <input type="text" name="subholding" id="subholding" disabled>
                </div>
                ...
                <div>
                    <label>Unit</label>
                    <input type="text" name="unit" id="unit" disabled>
                </div>

                <div>
                    <label>Posisi Awal Tahun</label>
                    <input type="number" name="posisi_awal_tahun" id="posisi_awal_tahun" disabled>
                </div>

                <div>
                    <label>Posisi Vacant Awal Tahun</label>
                    <input type="number" name="posisi_vacant_awal_tahun" id="posisi_vacant_awal_tahun" disabled>
                </div>

                <div>
                    <label>Posisi Terisi Awal Tahun</label>
                    <input type="number" name="posisi_terisi_awal_tahun" id="posisi_terisi_awal_tahun" disabled>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="target_personil_memenuhi_sertifikasi_tahunan"
                        id="target_personil_memenuhi_sertifikasi_tahunan" disabled>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_learning_hours" id="jumlah_learning_hours" disabled>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_sertifikasi_sudah_terbit_kumulatif"
                        id="jumlah_sertifikasi_sudah_terbit_kumulatif" disabled>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="target_personil_memenuhi_sertifikasi_bulanan"
                        id="target_personil_memenuhi_sertifikasi_bulanan" disabled>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="target_personil_memenuhi_sertifikasi_kumulatif"
                        id="target_personil_memenuhi_sertifikasi_kumulatif" disabled>
                </div>

                <div>
                    <label>Target KPI</label>
                    <input type="number" name="target_kpi" id="target_kpi" disabled>
                </div>

                <div>
                    <label>Real</label>
                    <input type="number" name="real" id="real" disabled>
                </div>

                <div>
                    <label>Real Kumulatif</label>
                    <input type="number" name="real_kumulatif" id="real_kumulatif" disabled>
                </div>

                <div>
                    <label>Real KPI</label>
                    <input type="number" name="real_kpi" id="real_kpi" disabled>
                </div>

                <div>
                    <label>Real KPI Kumulatif</label>
                    <input type="number" name="real_kpi_kumulatif" id="real_kpi_kumulatif" disabled>
                </div>

                <div>
                    <label>KPI Summary</label>
                    <input type="number" name="kpi_summary" id="kpi_summary" disabled>
                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`shg-kpi-mandatory-certi-summary/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/kinerja/shg-kpi-mandatory-certi-summary/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const columnMap = {
                    "shg-kpi-mandatory-certi-summary": [{
                            title: "No",
                            hozAlign: "center",
                            width: 60,
                            download: false,
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["shg-kpi-mandatory-certi-summary"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "shg-kpi-mandatory-certi-summary.xlsx", {
                        sheetName: "shg-kpi-mandatory-certi-summary",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`shg-kpi-mandatory-certi-summary/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("shg-kpi-mandatory-certi-summary", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData(`${BASE_URL}/monev/shg/kinerja/shg-kpi-mandatory-certi-summary/data`);
                            this.reset();
                            closeModal();
                        } else {
