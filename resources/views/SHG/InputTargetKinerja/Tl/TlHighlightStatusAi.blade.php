    ...
    @push('scripts')
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "tindak-lanjut-highlight-status-ai": [{
                            title: "No",
                            formatter: "rownum",
                            hozAlign: "center",
                            width: 60,
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["tindak-lanjut-highlight-status-ai"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "tindak-lanjut-highlight-status-ai.xlsx", {
                        sheetName: "tindak-lanjut-highlight-status-ai",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`tindak-lanjut-highlight-status-ai/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("tindak-lanjut-highlight-status-ai", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
