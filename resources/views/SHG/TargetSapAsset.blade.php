...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shg/kinerja/target-sap-asset/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "target-sap-asset": [{
                        ...
                        {
                            title: "Jumlah Unit Yang Harus Dibenahi",
                            field: "jumlah_unit_yang_harus_dibenahi",
                            editor: "number",
                            hozAlign: "center"
                        },
                        {
                            title: "Jumlah Unit Yang Sedang Dibenahi",
                            field: "jumlah_unit_yang_sedang_dibenahi",
                            editor: "number",
                            hozAlign: "center"
                        },
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["target-sap-asset"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "target-sap-asset.xlsx", {
                        sheetName: "target-sap-asset",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`target-sap-asset/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("target-sap-asset", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shg/kinerja/target-sap-asset/data");
                            this.reset();
                            closeModal();
                        } else {
