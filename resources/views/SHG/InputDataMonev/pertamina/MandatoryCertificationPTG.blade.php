...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            const routeMap = {
                "columns": "{{ route('mandatory-certification-ptg.data') }}",
            };
            ...
            document.addEventListener("DOMContentLoaded", function() {
                loadTabData("mandatory-certification-ptgp");
                ...
                fetch(url, {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shg/kinerja/mandatory-certification-ptg/data");
                            this.reset();
                        } else {
                            alert('Gagal menyimpan data');
                        }
