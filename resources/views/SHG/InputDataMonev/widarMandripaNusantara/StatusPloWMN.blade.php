...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Pelatihan AIMS WMN</h5>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/input-data/status-plo-wmn/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["status-plo-wmn"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "status-plo-wmn.xlsx", {
                        sheetName: "status-plo-wmn",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`status-plo-wmn/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                const url = data.id ? `status-plo-wmn/${data.id}` : "status-plo-wmn";
                ...
                Promise.all(
                    ...
                    .then(results => {
                        ...
                        if (gagal.length === 0) {
                            alert(`${jumlahRow} data berhasil disimpan`);
                        } else {
                            alert(`${gagal.length} dari ${jumlahRow} data gagal disimpan`);
                        }

                        table.setData(`${BASE_URL}/monev/shg/input-data/status-plo-wmn/data`);
                        this.reset();
                        closeModal();
                    })
                    .catch(error => {
