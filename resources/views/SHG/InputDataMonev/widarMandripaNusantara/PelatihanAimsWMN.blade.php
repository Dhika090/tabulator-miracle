...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/input-data/pelatihan-aims-wmn/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["pelatihan-aims-wmn"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "pelatihan-aims-wmn.xlsx", {
                        sheetName: "pelatihan-aims-wmn",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`pelatihan-aims-wmn/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(
                    ...
                    .then(results => {
                        ...
                        table.setData(`${BASE_URL}/monev/shg/input-data/pelatihan-aims-wmn/data`);
                        this.reset();
                        closeModal();
                    })
                    .catch(error => {
