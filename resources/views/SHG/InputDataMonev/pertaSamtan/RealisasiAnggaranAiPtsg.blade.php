...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shg/input-data/realisasi-anggaran-ai-ptsg/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("realisasi-anggaran-ai-ptsg", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shg/input-data/realisasi-anggaran-ai-ptsg/data");
                            this.reset();
                            closeModal();
                        } else {
