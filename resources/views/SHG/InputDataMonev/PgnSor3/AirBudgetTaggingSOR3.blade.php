...
<x-layouts.app :title="__('')">
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Data Air Budget Tagging SOR3</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shg/input-data/air-budget-tagging-sor3/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("air-budget-tagging-sor3", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shg/input-data/air-budget-tagging-sor3/data");
                            this.reset();
                            closeModal();
                       } else {
