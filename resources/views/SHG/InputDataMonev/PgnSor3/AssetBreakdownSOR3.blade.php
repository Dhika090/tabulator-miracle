...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/input-data/asset-breakdown-sor3/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "asset-breakdown-sor3.xlsx", {
                        sheetName: "asset-breakdown-sor3",
                        columnHeaders: true,
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("asset-breakdown-sor3", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(`${BASE_URL}/monev/shg/input-data/asset-breakdown-sor3/data`);
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
