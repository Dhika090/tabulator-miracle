...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shg/input-data/status-plo-kjg/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["status-plo-kjg"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "status-plo-kjg.xlsx", {
                        sheetName: "status-plo-kjg",
                        columnHeaders: true,
                ...
                fetch(url, {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shg/input-data/status-plo-kjg/data");
                            this.reset();
                        } else {
