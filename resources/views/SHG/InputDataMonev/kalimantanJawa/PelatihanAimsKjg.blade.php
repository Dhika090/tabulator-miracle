...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shg/input-data/pelatihan-aims-kjg/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["pelatihan-aims-kjg"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "pelatihan-aims-kjg.xlsx", {
                        sheetName: "pelatihan-aims-kjg",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`pelatihan-aims-kjg/${rowData.id}`, {
                                method: "PUT",
                                headers: {
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("pelatihan-aims-kjg", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(`${BASE_URL}/monev/shg/input-data/pelatihan-aims-kjg/data`);
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
