...
<x-layouts.app :title="__('')">
        ...
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex">
                    ...
                    <button class="btn btn-outline-secondary ms-2 h-100 mt-1" type="button" onclick="clearSearch()">Clear</button>
                </div>
            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shg/input-data/pelatihan-aims-kjg/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
                ...
                fetch("pelatihan-aims-kjg", {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shg/input-data/pelatihan-aims-kjg/data");
                            this.reset();
                            closeModal();
                        } else {
