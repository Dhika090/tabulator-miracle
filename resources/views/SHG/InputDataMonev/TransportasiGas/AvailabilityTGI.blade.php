...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Availability TGI</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Data Availability TGI</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shg/input-data/availability-tgi/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["availability-tgi"],
                    selectableRange: 1,
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "availability-tgi.xlsx", {
                        sheetName: "availability-tgi",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => updateRow(rowData));
                });
                ...
                function updateRow(rowData) {
                    ...
                    if (target !== undefined && typeof target === "string") {
                        rowData.target = parseFloat(target.replace("%", "").trim());
                    }

                    if (availability !== undefined && typeof availability === "string") {
                        rowData.availability = parseFloat(availability.replace("%", "").trim());
                    }

                    fetch(`availability-tgi/${rowData.id}`, {
                            method: "PUT",
                            headers: {
                        ...
                        .then(res => res.json())
                        .then(response => console.log("Data berhasil disimpan:", response))
                        .catch(err => console.error("Gagal menyimpan hasil paste:", err));
                }
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("availability-tgi", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shg/input-data/availability-tgi/data");
                            this.reset();
                            closeModal();
                       } else {
