...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Sistem Informasi AIMS TGI</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Sistem Informasi AIMS TGI</h3>
            <form id="createForm">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="total_wo_comply" name="total_wo_comply">
                </div>

                <div>
                    <label for="total_wo_completed">Total WO Completed</label>
                    <input type="number" step="0.01" id="total_wo_completed" name="total_wo_completed">
                </div>

                <div>
                    <label for="total_wo_in_progress">Total WO In Progress</label>
                    <input type="number" step="0.01" id="total_wo_in_progress" name="total_wo_in_progress">
                </div>

                <div>
                    <label for="total_wo_backlog">Total WO Backlog</label>
                    <input type="number" step="0.01" id="total_wo_backlog" name="total_wo_backlog">
                </div>
        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`sistem-informasi-aims-tgi/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shg/input-data/sistem-informasi-aims-tgi/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["sistem-informasi-aims-tgi"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "sistem-informasi-aims-tgi.xlsx", {
                        sheetName: "sistem-informasi-aims-tgi",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`sistem-informasi-aims-tgi/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("sistem-informasi-aims-tgi", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shg/input-data/sistem-informasi-aims-tgi/data");
                            this.reset();
                            closeModal();
                        } else {
