...
<x-layouts.app :title="__('TindakLanjutHasilMonev')">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title mb-3 d-flex justify-content-between">Tindak Lanjut Hasil Monev</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <form id="createForm">
                ...
                <label>Bahasan:</label>
                <input type="text" name="bahasan" required><br>

                <label>RTL:</label>
                <input type="text" name="rtl" required><br>
