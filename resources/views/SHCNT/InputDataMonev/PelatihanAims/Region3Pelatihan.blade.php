    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`pelatihan-aims-region-3/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shcnt/input-data/pelatihan-aims-region-3/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["pelatihan-aims-region-3"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "pelatihan-aims-region-3.xlsx", {
                        sheetName: "pelatihan-aims-region-3",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    console.log("Baris yang berubah:", changedRows);
                     ...
                     changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`pelatihan-aims-region-3/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("pelatihan-aims-region-3", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(`${BASE_URL}/monev/shcnt/input-data/pelatihan-aims-region-3/data`);
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
