...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">SHCNT Sap Asset Region 7</h5>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shcnt/input-data/sap-asset-region-7/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["sap-asset-region-7"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "sap-asset-region-7.xlsx", {
                        sheetName: "sap-asset-region-7",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`sap-asset-region-7/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("sap-asset-region-7", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData("/monev/shcnt/input-data/sap-asset-region-7/data");
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
