...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Realisasi Progress Fisik Ai Region 5</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Realisasi Progress Fisik Ai Region 5</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`realisasi-prog-fisik-ai-region-5/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shcnt/input-data/realisasi-prog-fisik-ai-region-5/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "realisasi-prog-fisik-ai-region-5": [{
                            title: "No",
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["realisasi-prog-fisik-ai-region-5"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "realisasi-prog-fisik-ai-region-5.xlsx", {
                        sheetName: "realisasi-prog-fisik-ai-region-5",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`realisasi-prog-fisik-ai-region-5/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("realisasi-prog-fisik-ai-region-5", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData("/monev/shcnt/input-data/realisasi-prog-fisik-ai-region-5/data");
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
