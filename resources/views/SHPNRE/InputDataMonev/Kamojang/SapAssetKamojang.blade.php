...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Sap Asset Kamojang</h5>
        ...
        <div class="modal-content">
            ...
            <form id="createForm">
                ...
                <div>
                    ...
                    <input type="text" name="belum_mulai" id="belum_mulai">
                </div>

                <div>
                    <label>Kickoff Meeting</label>
                    <input type="text" name="kickoff_meeting" id="kickoff_meeting">
                </div>

                <div>
                    <label>Identifikasi Peralatan</label>
                    <input type="text" name="identifikasi_peralatan" id="identifikasi_peralatan">
                </div>

                <div>
                    <label>Survey Lapangan</label>
                    <input type="text" name="survey_lapangan" id="survey_lapangan">
                </div>

                <div>
                    <label>Pembenahan Funloc</label>
                    <input type="text" name="pembenahan_funloc" id="pembenahan_funloc">
                </div>

                <div>
                    <label>Review Criticality</label>
                    <input type="text" name="review_criticality" id="review_criticality">
                </div>

                <div>
                    <label>Penyelarasan Dokumen dan Lapangan</label>
                    <input type="text" name="penyelarasan_dokumen_dan_lapangan"
                        id="penyelarasan_dokumen_dan_lapangan">
                </div>

                <div>
                    <label>Melengkapi Tag Fisik</label>
                    <input type="text" name="melengkapi_tag_fisik" id="melengkapi_tag_fisik">
                </div>

                <div>
                    <label>Mempersiapkan Form Upload Data</label>
                    <input type="text" name="mempersiapkan_form_upload_data" id="mempersiapkan_form_upload_data">
                </div>

                <div>
                    <label>Request ke Master Data</label>
                    <input type="text" name="request_ke_master_data" id="request_ke_master_data">
                </div>

                <div>
                    <label>Update di Master Data</label>
                    <input type="text" name="update_di_master_data" id="update_di_master_data">
                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/sap-asset-kamojang/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["sap-asset-kamojang"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "sap-asset-kamojang.xlsx", {
                        sheetName: "sap-asset-kamojang",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`sap-asset-kamojang/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("sap-asset-kamojang", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shpnre/input-data/sap-asset-kamojang/data");
                            this.reset();
                            closeModal();
                        } else {
