...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Availability Lumut Balai</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Data Availability Lumut Balai</h3>
            <form id="createForm">
        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`availability-lahendong/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/availability-lahendong/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["availability-lahendong"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "availability-lahendong.xlsx", {
                        sheetName: "availability-lahendong",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        ...
                        fetch(`availability-lahendong/${rowData.id}`, {
                                method: "PUT",
                                headers: {
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("availability-lahendong", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shpnre/input-data/availability-lahendong/data");
                            this.reset();
                            closeModal();
                        } else {
