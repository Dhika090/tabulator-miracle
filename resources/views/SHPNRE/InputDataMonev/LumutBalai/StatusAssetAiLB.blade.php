...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Status Asset 2025 AI Lumut Balai</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Create New Data Status Asset 2025 AI</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/lumut-balai/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
                ...
                fetch("lumut-balai", {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shpnre/input-data/lumut-balai/data");
                            this.reset();
                            closeModal();
                        } else {
