        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`rencana-pemeliharaan-lb/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/rencana-pemeliharaan-lb/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["rencana-pemeliharaan-lb"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "rencana-pemeliharaan-lb.xlsx", {
                        sheetName: "rencana-pemeliharaan-lb",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`rencana-pemeliharaan-lb/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                ...
                fetch("rencana-pemeliharaan-lb", {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shpnre/input-data/rencana-pemeliharaan-lb/data");
                            this.reset();
                            closeModal();
                        } else {
