        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`real-prog-fisik-ai-lb/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/real-prog-fisik-ai-lb/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["real-prog-fisik-ai-lb"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "real-prog-fisik-ai-lb.xlsx", {
                        sheetName: "real-prog-fisik-ai-lb",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`real-prog-fisik-ai-lb/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                ...
                fetch("real-prog-fisik-ai-lb", {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shpnre/input-data/real-prog-fisik-ai-lb/data");
                            this.reset();
                            closeModal();
                        } else {
