        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`mandatory-certification-lb/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/mandatory-certification-lb/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["mandatory-certification-lb"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "pelatihan-aims-lb.xlsx", {
                        sheetName: "pelatihan-aims-lb",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`mandatory-certification-lb/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
           function showToast(message, type = "success") {
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("mandatory-certification-lb", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shpnre/input-data/mandatory-certification-lb/data");
                            this.reset();
                            closeModal();
                        } else {
