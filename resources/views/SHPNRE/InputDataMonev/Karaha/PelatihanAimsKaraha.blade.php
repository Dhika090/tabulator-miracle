    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Pelatihan AIMS Karaha</h5>
        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`pelatihan-aims-karaha/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/pelatihan-aims-karaha/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["pelatihan-aims-karaha"],
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`pelatihan-aims-karaha/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("pelatihan-aims-karaha", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shpnre/input-data/pelatihan-aims-karaha/data");
                            this.reset();
                            closeModal();
                        } else {
