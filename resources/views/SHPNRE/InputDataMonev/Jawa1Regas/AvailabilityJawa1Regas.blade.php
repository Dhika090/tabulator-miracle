...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Availability Jawa 1 Regas</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Data Availability Jawa 1 Regas</h3>
            <form id="createForm">
        ...
        <script>
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`availability-jawa1regas/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch("/monev/shpnre/input-data/availability-jawa1regas/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["availability-jawa1regas"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", () => {
                    table.download("xlsx", "availability-jawa1regas.xlsx", {
                        sheetName: "availability-jawa1regas",
                        columnHeaders: true,
                    ...
                    debounceTimer = setTimeout(() => {
                        ...
                        if (changedRows.length > 0) {
                            ...
                            Promise.all(changedRows.map(row =>
                                fetch(`availability-jawa1regas/${row.id}`, {
                                    method: "PUT",
                                    headers: {
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("availability-jawa1regas", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shpnre/input-data/availability-jawa1regas/data");
                            this.reset();
                            closeModal();
                        } else {
