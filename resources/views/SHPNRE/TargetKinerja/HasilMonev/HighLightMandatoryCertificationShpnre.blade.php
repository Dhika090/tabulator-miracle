...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Highlight Mandatory Certification SHPNRE</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Highlight Mandatory Certification SHPNRE</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`tindak-lanjut-highlight-mandatory-certification-shpnre/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shpnre/kinerja/tindak-lanjut-highlight-mandatory-certification-shpnre/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
                    ...
                    .catch(err => co1nsole.error("Gagal load data:", err));
            }

            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "tindak-lanjut-highlight-mandatory-certification-shpnre": [{
                            title: "No",
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    headerWordWrap: true,
                    autoResize: true,
                    columns: columnMap["tindak-lanjut-highlight-mandatory-certification-shpnre"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx",
                        "tindak-lanjut-highlight-mandatory-certification-shpnre.xlsx", {
                            sheetName: "tindak-lanjut-highlight-mandatory-certification-shpnre",
                            columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`tindak-lanjut-highlight-mandatory-certification-shpnre/${rowData.id}`, {
                                method: "PUT",
                                headers: {
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("tindak-lanjut-highlight-mandatory-certification-shpnre", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(
                            `${BASE_URL}/monev/shpnre/kinerja/tindak-lanjut-highlight-mandatory-certification-shpnre/data`
                        );
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
