...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Real Anggaran AI PET</h5>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shiml/input-data/real-anggaran-ai-pet/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
    ...
    formatter: (cell) => {
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["real-anggaran-ai-pet"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "real-anggaran-ai-pet.xlsx", {
                        sheetName: "real-anggaran-ai-pet",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`real-anggaran-ai-pet/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                ...
                fetch("real-anggaran-ai-pet", {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shiml/input-data/real-anggaran-ai-pet/data");
                            this.reset();
                            closeModal();
                        } else {
