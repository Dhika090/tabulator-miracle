...
<x-layouts.app :title="__('')">
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Target Asset Breakdown cilacap</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shrnp/input-data/asset-breakdown-cilacap/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
                ...
                fetch("asset-breakdown-cilacap", {
                    ...
                    .then(result => {
                        if (result.success) {
                            ...
                            table.setData("/monev/shrnp/input-data/asset-breakdown-cilacap/data");
                            this.reset();
                            closeModal();
                        } else {
