...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shrnp/input-data/kondisi-vacant-aims-kasim/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "kondisi-vacant-aims-kasim.xlsx", {
                        sheetName: "kondisi-vacant-aims-kasim",
                        columnHeaders: true,
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("kondisi-vacant-aims-kasim", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData("/monev/shrnp/input-data/kondisi-vacant-aims-kasim/data");
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
