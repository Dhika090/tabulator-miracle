...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shrnp/input-data/mandatory-certification-kasim/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "mandatory-certification-kasim.xlsx", {
                        sheetName: "mandatory-certification-kasim",
                        columnHeaders: true,
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("mandatory-certification-kasim", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData("/monev/shrnp/input-data/mandatory-certification-kasim/data");
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
