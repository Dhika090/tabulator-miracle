...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Status PLO Kasim</h5>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shrnp/input-data/status-plo-kasim/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["status-plo-kasim"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "status-plo-kasim.xlsx", {
                        sheetName: "status-plo-kasim",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`status-plo-kasim/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                    ...
                    .then(results => {
                        ...
                        table.setData(`${BASE_URL}/monev/shrnp/input-data/status-plo-kasim/data`);
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
