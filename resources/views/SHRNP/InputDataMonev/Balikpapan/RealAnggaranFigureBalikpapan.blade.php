...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Real Anggaran Figure Balikpapan</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Real Anggaran Figure Balikpapan</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`realisasi-anggaran-figure-balikpapan/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shrnp/input-data/realisasi-anggaran-figure-balikpapan/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "realisasi-anggaran-figure-balikpapan": [{
                            title: "No",
                            formatter: "rownum",
                            hozAlign: "center",
                            width: 60,
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["realisasi-anggaran-figure-balikpapan"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "realisasi-anggaran-figure-balikpapan.xlsx", {
                        sheetName: "realisasi-anggaran-figure-balikpapan",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`realisasi-anggaran-figure-balikpapan/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(
                        payloadArray.map(payload =>
                            fetch("realisasi-anggaran-figure-balikpapan", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(
                            `${BASE_URL}/monev/shrnp/input-data/realisasi-anggaran-figure-balikpapan/data`);
                        form.reset();
                        closeModal();
                    })
                    .catch(error => {
