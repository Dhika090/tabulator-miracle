    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`general-administrasi-non-rutin/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/mona/iis/general-administrasi-non-rutin/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "general-administrasi-non-rutin": [{
                            title: "No",
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["general-administrasi-non-rutin"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "general-administrasi-non-rutin.xlsx", {
                        sheetName: "general-administrasi-non-rutin",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        //     return;
                        // }
                        fetch(`general-administrasi-non-rutin/${rowData.id}`, {
                                method: "PUT",
                                headers: {
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                for (let i = 0; i < jumlahRow; i++) {
                    payloadArray.push({
                        ...
                        realisasi_penyelesaian: data.realisasi_penyelesaian,
                        status: data.status,
                        pic: data.pic,
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("general-administrasi-non-rutin", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(`${BASE_URL}/mona/iis/general-administrasi-non-rutin/data`);
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
