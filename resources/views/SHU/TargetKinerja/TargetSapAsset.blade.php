...
<x-layouts.app :title="__('')">
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.getElementById("search-input").addEventListener("input", function(e) {
                ...
                table.setFilter([
                    [{
                        ...
                        {
                            field: "jumlah_unit_yang_harus_dibenahi",
                            type: "like",
                            value: keyword
                        },
                        {
                            field: "jumlah_unit_yang_sedang_dibenahi",
                            type: "like",
                            value: keyword
                        }
                    ]
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shu/kinerja/target-sap-asset-shu/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "target-sap-asset-shu": [{
                        ...
                        {
                            title: "Unit yang harus dibenahi",
                            field: "jumlah_unit_yang_harus_dibenahi",
                            editor: "number",
                            hozAlign: "center"
                        },
                        {
                            title: "Unit yang sedang dibenahi",
                            field: "jumlah_unit_yang_sedang_dibenahi",
                            editor: "number",
                            hozAlign: "center"
                        },
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["target-sap-asset-shu"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "target-sap-asset-shu.xlsx", {
                        sheetName: "target-sap-asset-shu",
                        columnHeaders: true,
                ...
                function extractYearMonth(datetimeString) {
                    if (!datetimeString) return null;
                    return datetimeString.slice(0, 7);
                }
                ...
                table.on("cellEdited", function(cell) {
                    ...
                    const updatedMonth = extractYearMonth(updatedData.updated_at);
                    const createdMonth = extractYearMonth(updatedData.created_at);
                    const currentMonth = new Date().toISOString().slice(0, 7);

                    const canEdit =
                        (updatedMonth && updatedMonth === currentMonth) ||
                        (!updatedMonth && createdMonth === currentMonth);

                    if (!canEdit) {
                        showToast(
                            "Data ini tidak bisa diedit karena tidak dibuat atau diperbarui di bulan ini.",
                            "error");
                        table.replaceData();
                        return;
                    }
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(row => {
                        const updatedMonth = extractYearMonth(row.updated_at);
                        const createdMonth = extractYearMonth(row.created_at);
                    ...
                    if (blockedRows.length > 0) {
                        showToast(
                            "Beberapa data tidak bisa diedit karena tidak dibuat atau diubah di bulan ini.",
                            "error");
                        table.replaceData(previousData);
                        return;
                    }

                    allowedRows.forEach(rowData => {
                        fetch(`target-sap-asset-shu/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("target-sap-asset-shu", {
                        ...
                        body: JSON.stringify({
                            ...
                            unit: data.unit,
                            jumlah_unit_yang_harus_dibenahi: data.jumlah_unit_yang_harus_dibenahi,
                            jumlah_unit_yang_sedang_dibenahi: data.jumlah_unit_yang_sedang_dibenahi
                        })
                    })
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData(`${BASE_URL}/monev/shu/kinerja/target-sap-asset-shu/data`);
                            this.reset();
                            closeModal();
                        } else {
