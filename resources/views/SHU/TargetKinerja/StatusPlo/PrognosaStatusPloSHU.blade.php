        ...
        <div class="modal-content">
            ...
            <form id="createForm">
                ...
                <div>
                    ...
                    <input type="number" name="uncertified" id="uncertified">
                </div>
                ...
                <div>
                    <label>PLO Expired &lt;6</label>
                    <input type="number" name="exp_lt6" id="exp_lt6">
                </div>

                <div>
                    <label>PLO Valid</label>
    ...
    <script>
        ...
        function deleteData(id) {
            if (confirm("Yakin ingin menghapus data ini?")) {
                fetch(`shu-prognosa-status-plo/${id}`, {
                        method: "DELETE",
                        headers: {
        ...
        function loadData() {
            fetch(`${BASE_URL}/monev/shu/kinerja/shu-prognosa-status-plo/data`, {
                    headers: {
                        "Accept": "application/json"
                    }
                })
        ...
        `;
            ...
            window.table = new Tabulator("#example-table", {
                ...
                autoResize: true,
                columns: columnMap["shu-prognosa-status-plo"],
            ...
            document.getElementById("download-xlsx").addEventListener("click", function() {
                window.table.download("xlsx", "shu-prognosa-status-plo.xlsx", {
                    sheetName: "shu-prognosa-status-plo",
                    columnHeaders: true,
            ...
            table.on("dataChanged", function(newData) {
                ...
                changedRows.forEach(rowData => {
                    fetch(`shu-prognosa-status-plo/${rowData.id}`, {
                            method: "PUT",
                            headers: {
                                "Content-Type": "application/json",
                                "Accept": "application/json",
        ...
        document.getElementById("createForm").addEventListener("submit", function(e) {
            ...
            fetch("shu-prognosa-status-plo", {
                    ...
                    body: JSON.stringify({
                        ...
                        unit: data.unit,
                        exp: data.plo_expired,
                        exp_lt6: data.plo_expired_lt6,
                        valid: data.plo_valid
                    })
                })
                ...
                .then(result => {
                    if (result.success) {
                        showToast(result.message || "Data berhasil disimpan", "success");
                        table.setData(`${BASE_URL}/monev/shu/kinerja/shu-prognosa-status-plo/data`);
                        this.reset();
                        closeModal();
                    } else {
