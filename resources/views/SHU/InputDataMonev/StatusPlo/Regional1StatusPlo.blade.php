...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Status PLO Regional 1</h5>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadData() {
                fetch("/monev/shu/input-data/status-plo-regional-1/data", {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "status-plo-regional-1.xlsx", {
                        sheetName: "status-plo-regional-1",
                        columnHeaders: true,
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("status-plo-regional-1", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData("/monev/shu/input-data/status-plo-regional-1/data");
                            this.reset();
                            closeModal();
                        } else {
