...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Availability Regional 2</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Data Availability Regional 2</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`availability-regional-2/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shu/input-data/availability-regional-2/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["availability-regional-2"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", () => {
                    table.download("xlsx", "availability-regional-2.xlsx", {
                        sheetName: "availability-regional-2",
                        columnHeaders: true,
                    ...
                    debounceTimer = setTimeout(() => {
                        ...
                        if (changedRows.length > 0) {
                            ...
                            Promise.all(changedRows.map(row =>
                                fetch(`availability-regional-2/${row.id}`, {
                                    method: "PUT",
                                    headers: {
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("availability-regional-2", {
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData(`${BASE_URL}/monev/shu/input-data/availability-regional-2/data`);
                            this.reset();
                            closeModal();
                        } else {
