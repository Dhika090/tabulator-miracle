...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Real Anggaran Figure Regional 2</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Real Anggaran Figure Regional 2</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`realisasi-anggaran-figure-regional-2/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shu/input-data/realisasi-anggaran-figure-regional-2/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "realisasi-anggaran-figure-regional-2": [{
                            title: "No",
                            formatter: "rownum",
                            hozAlign: "center",
                            width: 60,
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    autoResize: true,
                    columns: columnMap["realisasi-anggaran-figure-regional-2"],
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "realisasi-anggaran-figure-regional-2.xlsx", {
                        sheetName: "realisasi-anggaran-figure-regional-2",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach(rowData => {
                        fetch(`realisasi-anggaran-figure-regional-2/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                fetch("realisasi-anggaran-figure-regional-2", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
                    ...
                    .then(result => {
                        if (result.success) {
                            showToast(result.message || "Data berhasil disimpan", "success");
                            table.setData(`${BASE_URL}/monev/shu/input-data/realisasi-anggaran-figure-regional-2/data`);
                            this.reset();
                            closeModal();
                        } else {
