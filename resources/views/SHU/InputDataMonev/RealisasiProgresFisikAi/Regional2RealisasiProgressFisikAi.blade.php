...
<x-layouts.app :title="__('')">
    ...
    <div class="card">
        <div class="card-body d-flex flex-column">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h5 class="card-title mb-3 mb-md-0">Realisasi Progress Fisik AI Regional 2</h5>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Tambah Realisasi Progress Fisik AI Regional 2</h3>
            <form id="createForm">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function deleteData(id) {
                if (confirm("Yakin ingin menghapus data ini?")) {
                    fetch(`realisasi-progres-fisik-ai-regional-2/${id}`, {
                            method: "DELETE",
                            headers: {
            ...
            function loadData() {
                fetch(`${BASE_URL}/monev/shu/input-data/realisasi-progres-fisik-ai-regional-2/data`, {
                        headers: {
                            "Accept": "application/json"
                        }
                    })
            ...
            document.addEventListener("DOMContentLoaded", function() {
                const columnMap = {
                    "realisasi-progres-fisik-ai-regional-2": [{
                            title: "No",
        ...
        `;
                ...
                window.table = new Tabulator("#example-table", {
                    ...
                    headerWordWrap: true,
                    autoResize: true,
                    columns: columnMap["realisasi-progres-fisik-ai-regional-2"],
                    virtualDom: true,
                    height: "700px",
                ...
                document.getElementById("download-xlsx").addEventListener("click", function() {
                    window.table.download("xlsx", "realisasi-progres-fisik-ai-regional-2.xlsx", {
                        sheetName: "realisasi-progres-fisik-ai-regional-2",
                        columnHeaders: true,
                ...
                table.on("dataChanged", function(newData) {
                    ...
                    changedRows.forEach((rowData, index) => {
                        ...
                        fetch(`realisasi-progres-fisik-ai-regional-2/${rowData.id}`, {
                                method: "PUT",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
        ...
        <script>
            ...
            document.getElementById("createForm").addEventListener("submit", function(e) {
                ...
                Promise.all(payloadArray.map(dataItem => {
                        return fetch("realisasi-progres-fisik-ai-regional-2", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                    ...
                    .then(results => {
                        ...
                        table.setData(
                            `${BASE_URL}/monev/shu/input-data/realisasi-progres-fisik-ai-regional-2/data`);
                        document.getElementById("createForm").reset();
                        closeModal();
                    })
                    .catch(error => {
