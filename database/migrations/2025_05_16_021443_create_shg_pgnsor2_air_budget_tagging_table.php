...
return new class extends Migration {
    ...
    {
        Schema::create('shg_pgnsor2_air_budget_tagging', function (Blueprint $table) {
            ...
            $table->string('jumlah_aset_critical_sece')->nullable();
            $table->string('jumlah_aset_critical_pce')->nullable();
            $table->string('jumlah_aset_important')->nullable();
            $table->string('jumlah_aset_secondary')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('shg_pgnsor2_air_budget_tagging');
    }
};
