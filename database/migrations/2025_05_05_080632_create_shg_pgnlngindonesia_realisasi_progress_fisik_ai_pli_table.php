...
return new class extends Migration {
    ...
    {
        Schema::create('shg_pgnlngindonesia_realisasi_progress_fisik_ai_pli', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shg_pgnlngindonesia_realisasi_progress_fisik_ai_pli');
    }
};
