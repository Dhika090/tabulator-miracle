...
return new class extends Migration {
    ...
    {
        Schema::create('shg_pertasamtan_realisasi_progress_fisik_ai_ptsg', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shg_pertasamtan_realisasi_progress_fisik_ai_ptsg');
    }
};
