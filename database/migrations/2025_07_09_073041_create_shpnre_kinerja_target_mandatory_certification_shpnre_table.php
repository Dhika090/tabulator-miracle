...
return new class extends Migration
{
    ...
    {
        Schema::create('shpnre_kinerja_target_mandatory_certification_shpnre', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shpnre_kinerja_target_mandatory_certification_shpnre');
    }
};
