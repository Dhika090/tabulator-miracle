...
return new class extends Migration {
    ...
    {
        Schema::create('shg_pgnsor1_air_budget_tagging', function (Blueprint $table) {
            ...
            $table->decimal('jumlah_aset_critical_sece', 15, 2)->nullable();
            $table->decimal('jumlah_aset_critical_pce', 15, 2)->nullable();
            $table->decimal('jumlah_aset_important', 15, 2)->nullable();
            $table->decimal('jumlah_aset_secondary', 15, 2)->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('shg_pgnsor1_air_budget_tagging');
    }
};
