...
return new class extends Migration
{
    ...
    {
        Schema::create('shg_pertamina_realisasi_anggaran_ai_ptg_2025', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shg_pertamina_realisasi_anggaran_ai_ptg_2025');
    }
};
