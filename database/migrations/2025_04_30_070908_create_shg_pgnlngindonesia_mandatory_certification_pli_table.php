...
return new class extends Migration
{
    ...
    {
        Schema::create('shg_pgnlngindonesia_mandatory_certification_pli', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shg_pgnlngindonesia_mandatory_certification_pli');
    }
};
