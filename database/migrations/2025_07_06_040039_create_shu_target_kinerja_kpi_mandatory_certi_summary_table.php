...
return new class extends Migration
{
    ...
    {
        Schema::create('shu_target_kinerja_kpi_mandatory_certi_summary', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shu_target_kinerja_kpi_mandatory_certi_summary');
    }
};
